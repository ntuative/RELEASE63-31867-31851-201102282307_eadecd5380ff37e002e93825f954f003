package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_615:Number = 64;
      
      public static const const_1084:Number = 32;
      ...
      private var var_146:Vector3d;
      
      private var var_147:Vector3d;
      
      private var var_1214:Vector3d;
      ...
      private var var_1921:Number = 1.0;
      
      private var var_1922:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1214 = new Vector3d();
         this.var_1923 = 1;
         this.var_1921 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1922 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_147.x,this.var_147.y,this.var_147.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_81.x * this.var_437,this.var_81.y * this.var_438,this.var_81.z * this.var_436);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_266.x,this.var_266.y,this.var_266.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_437 != param1 * this.var_1923)
         {
            this.var_437 = param1 * this.var_1923;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_438 != param1 * this.var_1921)
         {
            this.var_438 = param1 * this.var_1921;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1922)
         {
            this.var_436 = param1 * this.var_1922;
            ++this.var_161;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_81.x /= this.var_437;
         this.var_81.y /= this.var_438;
         this.var_81.z /= this.var_436;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_266.x;
         var _loc3_:Number = this.var_266.y;
         var _loc4_:Number = this.var_266.z;
         this.var_266.assign(param1);
         if(this.var_266.x != _loc2_ || this.var_266.y != _loc3_ || this.var_266.z != _loc4_)
         {
            ++this.var_161;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_146.assign(_loc24_);
            this.var_147.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_146.assign(_loc19_);
            this.var_147.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_523 != null)
         {
            ...
            this.var_523.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_523.add(_loc3_,_loc4_);
            ++this.var_161;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_523 != null)
         {
            ...
            return this.var_523.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1214.assign(_loc22_);
         }
         else
         {
            this.var_1214.assign(_loc17_);
         }
         ++this.var_161;
      }
      ...
      {
         if(param1 == null || this.var_147 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_147,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_146);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_147);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_437;
         _loc2_.y *= this.var_438;
         _loc2_.z *= this.var_436;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1214);
         if(_loc3_ < this.var_2796 || _loc3_ > this.var_2795)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_146);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_438;
            _loc2_.z *= this.var_436;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1214);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_146,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_81.x * this.var_437,this.var_81.y * this.var_438,this.var_81.z * this.var_436);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_147;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_437,param2.y * this.var_438,param2.z * this.var_436);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_437,param3.y * this.var_438,param3.z * this.var_436);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_437,param4.y * this.var_438,param4.z * this.var_436);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1084;
         }
         else
         {
            this.scale = const_615;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_615;
      }
