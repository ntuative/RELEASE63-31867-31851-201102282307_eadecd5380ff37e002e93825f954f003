package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_146 * this.var_146 + this.var_147 * this.var_147);
         }
         return this._length;
      }
      ...
      {
         return "(" + [this._x,this.var_146,this.var_147].join(",") + ")";
      }
   }
}
