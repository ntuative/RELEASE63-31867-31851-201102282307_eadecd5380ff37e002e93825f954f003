package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1557 || param2 != this.var_1558)
         {
      ...
      {
         if(this.var_1281 > 255 || bitmapData == null)
         {
            return false;
         }
