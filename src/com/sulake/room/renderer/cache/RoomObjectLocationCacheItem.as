package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1627 || param1.getUpdateID() != this.var_2274)
         {
            this.var_2274 = param1.getUpdateID();
            if(param2.updateId != this.var_1627 || _loc4_.x != this.var_1068.x || _loc4_.y != this.var_1068.y || _loc4_.z != this.var_1068.z)
            {
               this.var_1627 = param2.updateId;
               this.var_1068.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2273 = _loc3_;
         if(_loc3_)
         {
