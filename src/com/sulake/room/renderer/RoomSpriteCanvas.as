package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1687:int = 50;
      ...
      private var var_1376:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2450:Number = -1.0E7;
      
      private var var_2451:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_241 = new Sprite();
         this.var_241.mouseEnabled = false;
         this.var_59 = new Sprite();
         this.var_59.name = "canvas";
         this.var_59.mouseEnabled = false;
         this.var_241.addChild(this.var_59);
      ...
      {
         this.var_493.x -= param1 - this.var_598;
         this.var_598 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_493.y -= param1 - this.var_600;
         this.var_600 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_968 = true;
            if(this.var_127 != null && !this.var_241.contains(this.var_127))
            {
               this.var_241.addChild(this.var_127);
               this.var_59.mask = this.var_127;
            }
         }
         else if(!param1 && this.var_968)
         {
            this.var_968 = false;
            if(this.var_127 != null && this.var_241.contains(this.var_127))
            {
               this.var_241.removeChild(this.var_127);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_241.numChildren > 0)
            {
               this.var_241.removeChildAt(0);
            }
            this.var_241 = null;
         }
         this.var_59 = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_720 != this.var_2448 || this._ht != this.var_2452)
         {
            _loc9_ = true;
         }
         if(this.var_59.x != this.var_598 || this.var_59.y != this.var_600)
         {
            this.var_59.x = this.var_598;
            this.var_59.y = this.var_600;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_494.sortOn("z",0 | 0);
         if(_loc5_ < this.var_494.length)
         {
            this.var_494.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_494[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2448 = this.var_720;
         this.var_2452 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_598;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_600;
                  if(_loc19_ < this.var_720 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_494.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_598;
                     _loc17_.y = _loc20_ - this.var_600;
      ...
      {
         if(param1 < 0 || param1 >= this.var_494.length)
         {
            return null;
         }
         return this.var_494[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1116 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1734;
         }
         this.var_1734 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1116;
         return this.var_1734;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1735,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2450 || param2 != this.var_2451)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_353.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1376.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
