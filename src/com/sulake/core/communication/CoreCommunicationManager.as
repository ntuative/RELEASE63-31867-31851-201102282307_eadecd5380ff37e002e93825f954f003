package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1879:IConnectionStateListener;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1052:
               _loc3_ = new SocketConnection(param1,this,this.var_1879);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1183[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:Array = this.var_969[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_969[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_969[_loc3_];
