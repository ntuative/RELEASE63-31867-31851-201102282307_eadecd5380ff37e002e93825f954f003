package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_412:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1095:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1238 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1238);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1358 & const_1095)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_964 = false;
            this._events.dispatchEvent(new LockEvent(const_412,this));
         }
      }
