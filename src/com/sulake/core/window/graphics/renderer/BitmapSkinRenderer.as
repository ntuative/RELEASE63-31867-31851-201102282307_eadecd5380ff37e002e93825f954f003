package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private static var var_32:Rectangle = new Rectangle();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_444[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  _loc12_ = false;
                  _loc13_ = false;
                  var_32.x = _loc10_.region.x + param3.x;
                  var_32.y = _loc10_.region.y + param3.y;
                  var_32.width = _loc10_.region.width;
                  var_32.height = _loc10_.region.height;
                  if(_loc10_.scaleH == SkinLayoutEntity.const_299)
                  {
                     var_32.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_525)
                  {
                     _loc12_ = true;
                     var_32.right += _loc14_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_312)
                  {
                     _loc12_ = true;
                     var_32.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_299)
                  {
                     var_32.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_525)
                  {
                     _loc13_ = true;
                     var_32.bottom += _loc15_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_312)
                  {
                     _loc13_ = true;
                     var_32.bottom += _loc15_;
                     if(true)
                  ...
                  if(!_loc12_ && !_loc13_)
                  {
                     _loc6_.copyPixels(_loc17_,_loc17_.rect,var_32.topLeft,_loc18_,TOP_LEFT,true);
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_312 || _loc10_.scaleH == SkinLayoutEntity.const_312)
                  {
                     ...
                     _loc23_ = 0 % _loc19_;
                     _loc24_ = 0 % _loc20_;
                     _loc25_ = new Point(var_32.x,var_32.y);
                  ...
                  {
                     _loc6_.fillRect(var_32,_loc17_.getPixel(0,0) | _loc18_.getPixel32(0,0) & 4278190080);
                  }
                  else
                  {
                     this.var_816.a = 0 / _loc17_.width;
                     this.var_816.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_32.width,var_32.height,false);
                     _loc30_.draw(_loc17_,this.var_816);
                     _loc31_ = new BitmapData(var_32.width,var_32.height,true,0);
                     _loc31_.draw(_loc18_,this.var_816,null);
                     _loc6_.copyPixels(_loc30_,_loc30_.rect,var_32.topLeft,_loc31_,TOP_LEFT,true);
                     _loc31_.dispose();
                     _loc30_.dispose();
                  }
               }
