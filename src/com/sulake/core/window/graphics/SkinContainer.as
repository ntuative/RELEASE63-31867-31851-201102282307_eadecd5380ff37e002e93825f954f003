package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_948:uint = 8;
      
      private static const const_1322:String = "skin";
      
      private static const const_1323:String = "bitmap";
      
      private static const const_1326:String = "fill";
      
      private static const const_1325:String = "text";
      
      private static const const_1327:String = "label";
      
      private static const const_1324:String = "shape";
      ...
      private var var_2476:Dictionary;
      
      private var var_2474:Dictionary;
      
      private var var_2475:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2476 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1747,this.var_2476);
         this.var_2474 = new Dictionary();
         this.var_2475 = new Dictionary();
         StateCodeTable.fillTables(this.var_2474,this.var_2475);
         this.var_416 = new Dictionary();
         this.var_416[const_1322] = BitmapSkinRenderer;
         this.var_416[const_1323] = BitmapDataRenderer;
         this.var_416[const_1326] = FillSkinRenderer;
         this.var_416[const_1325] = TextSkinRenderer;
         this.var_416[const_1327] = LabelRenderer;
         this.var_416[const_1324] = ShapeSkinRenderer;
         ...
         if(var_317 == null)
         {
            ...
            var_317.push(WindowState.const_74);
            var_317.push(WindowState.const_85);
            var_317.push(WindowState.const_54);
            var_317.push(WindowState.const_87);
            var_317.push(WindowState.const_81);
            var_317.push(WindowState.const_106);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2734 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1747[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_922[param1] = new Array(const_948);
         }
         this.var_922[param1][param2] = param3;
         if(this.var_921[param1] == null)
         {
            this.var_921[param1] = new Array(const_948);
         }
         this.var_921[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_922[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_921[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_179)
