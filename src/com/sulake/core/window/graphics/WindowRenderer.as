   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_301,WindowRedrawFlag.const_1182);
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_867);
            this.var_361[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_644,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_644,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_361[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1813,this.var_1423))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1813,this.var_1423))
               {
