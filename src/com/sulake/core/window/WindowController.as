package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1021:uint = 0;
      ...
      protected static const const_1660:String = "_IGNORE_INHERITED_STYLE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_375 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_61 = var_375.clone();
            var_11 = var_375.clone();
         ...
         if(_loc13_)
         {
            var_755 = _loc13_.blend;
            var_441 = _loc13_.var_2734;
      ...
      {
         return this.var_646 != null ? this.var_646 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_442 = param1;
         var_225 = !!var_442 ? uint(var_225 | var_526) : uint(var_225 & 16777215);
         this.var_163 = this.var_163 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_225 = !!var_442 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_526 = param1 << 24;
         var_225 = !!var_442 ? uint(var_526 | var_225) : uint(16777215 & var_225);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      
      public function set blend(param1:Number) : void
      {
         var_755 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      {
         var_441 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_322 = this._parent.rectangle.clone();
               var_61.x = var_11.x;
               var_61.y = var_11.y;
               var_61.width = var_11.width;
               var_61.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_578,this,this._parent));
            }
            else
            {
               this.var_322.x = 0;
               this.var_322.y = 0;
               this.var_322.width = 0;
               this.var_322.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1098,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_779,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_82,var_18,_context,var_11,null,this.var_646,this.properties,var_799.concat(),_id) as WindowController;
         _loc2_.var_441 = var_441;
         _loc2_.var_163 = this.var_163;
         _loc2_._debug = this._debug;
         _loc2_.var_322 = this.var_322.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_375 = var_375.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2099 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_561)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_483)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1038,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_739,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_202,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_727))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1201;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_202:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_182,WindowParam.const_163))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_159))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_559))
                        {
                        ...
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_282,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_513:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_478);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1023,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_325,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_378:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_761,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_220,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_468:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1106);
                  break;
               case WindowNotifyEvent.const_471:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1660) == -1)
                     {
                        _loc8_.style = var_82;
                     }
                  }
               ...
               case WindowNotifyEvent.const_465:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_478);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_566:
                  this._parent.getRegionProperties(null,this.var_322);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1136:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1150:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_465:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_761:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_220:
               _loc2_ = "null";
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_441);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_441);
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_139,WindowParam.const_163);
         var _loc2_:* = !testParamFlag(WindowParam.const_154,WindowParam.const_159);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_322.width;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_373)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_322.height;
               _loc5_ = uint(var_18 & 0);
      ...
      {
         if(_state == WindowState.const_464)
         {
            return true;
         }
         _state = WindowState.const_464;
         ...
         _loc1_.type = WindowNotifyEvent.const_1090;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1101,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1022 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1022 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_820,this,param1));
         return param1;
      }
