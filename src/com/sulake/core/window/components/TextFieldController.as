package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1486:uint = 500;
      
      protected var var_1229:String = "";
      
      protected var var_1239:Boolean = false;
      ...
      {
         this.var_1229 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1197,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_682 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_358,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_698,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1571);
         _loc1_.push(this.var_1239 != PropertyDefaults.const_1044 ? new PropertyStruct(PropertyDefaults.const_878,this.var_1239,PropertyStruct.const_35,true) : PropertyDefaults.const_1377);
         _loc1_.push(_field.selectable != PropertyDefaults.const_995 ? new PropertyStruct(PropertyDefaults.const_749,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1365);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1096 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1388);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_878:
                  this.var_1239 = _loc2_.value as Boolean;
                  if(this.var_1239)
                  {
