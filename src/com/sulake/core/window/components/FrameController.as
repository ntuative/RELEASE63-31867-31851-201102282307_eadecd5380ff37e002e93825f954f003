package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1237:String = "_HEADER";
      
      private static const const_1238:String = "_CONTENT";
      
      private static const const_1239:String = "_SCALER";
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1294 = findChildByTag(const_1237) as IHeaderWindow;
            if(!this.var_1294)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_168 = findChildByTag(const_1238) as IWindowContainer;
            if(!this.var_168)
            {
      ...
      {
         return findChildByTag(const_1239) as IScalerWindow;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,_loc3_.left,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,_loc3_.top,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_258,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         }
         else
         {
