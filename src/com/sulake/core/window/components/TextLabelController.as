package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_390);
         if(_loc1_)
         {
      ...
      {
         if(this.var_390 != param1.name)
         {
            this.var_390 = param1.name;
            this.refresh();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_346 != _loc2_.color : this.var_346 != null && this.var_346 != PropertyDefaults.const_681) ? new PropertyStruct(PropertyDefaults.const_369,this.var_346,PropertyStruct.const_143,true) : PropertyDefaults.const_1031);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_800)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,this.var_40.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_582);
            }
            if(this.var_40.top != PropertyDefaults.const_679)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,this.var_40.top,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_461);
            }
            if(this.var_40.right != PropertyDefaults.const_662)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,this.var_40.right,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_557);
            }
            if(this.var_40.bottom != PropertyDefaults.const_685)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_258,this.var_40.bottom,PropertyStruct.const_39,true));
            }
            else
            {
