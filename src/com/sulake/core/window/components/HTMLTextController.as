package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_977:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1902:StyleSheet = null;
      ...
      {
         this.var_778 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_743.indexOf(param1) > -1)
         {
            this.var_778 = param1;
         }
      }
      ...
      {
         return this.var_778 == LinkTarget.const_31 ? defaultLinkTarget : this.var_778;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1902;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_778 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_659,this.var_778,PropertyStruct.const_51,true,PropertyDefaults.const_743));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1367);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_778 = _loc2_.value as String;
               break;
            }
