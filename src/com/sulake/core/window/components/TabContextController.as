package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1310:String = "_SELECTOR";
      
      private static const const_1311:String = "_CONTENT";
       
      
      protected var var_999:ITabSelectorWindow;
      
      protected var var_1993:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_999 = findChildByTag(const_1310) as ITabSelectorWindow;
            if(this.var_999 != null)
            {
               this.var_999.procedure = this.selectorEventProc;
            }
         }
         return this.var_999;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1993 = findChildByTag(const_1311) as IWindowContainer;
         }
      ...
      {
         return !!this.var_682 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_999.numSelectables;
      }
