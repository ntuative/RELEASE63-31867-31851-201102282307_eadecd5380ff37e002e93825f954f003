package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_248.lenght - 1)
         {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_611 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_401,this,null));
         }
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_175 == null || this.var_175.disposed)
         {
            this.var_175 = context.create(name + "::submenu","",WindowType.const_534,var_82,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_248.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_931 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_931)
         {
            if(this.open())
            {
               if(this.var_248.length)
               {
                  this.populateMenuItemContainer(this.var_248,this.getSubMenu(),this.subMenuEventProc);
                  this.var_931 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_931 = false;
            this.getTitleLabel().text = this.var_611 < this.var_248.length && this.var_611 > -1 ? this.var_248[this.var_611] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_454,var_82,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_334,var_82,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_611 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_611).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_462)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1125:
            case WindowMouseEvent.const_59:
               ...
               break;
            case WindowTouchEvent.const_674:
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1079;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_248[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_248.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_664,this.var_248,PropertyStruct.const_149,true));
         }
         else
         {
