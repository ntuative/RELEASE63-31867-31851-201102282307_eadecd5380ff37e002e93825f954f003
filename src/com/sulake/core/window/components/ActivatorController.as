package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         else if(param2.type == WindowNotifyEvent.const_761)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_807;
         if(this.var_807 != param1)
         {
            if(this.var_807 != null)
            {
               if(!this.var_807.disposed)
               {
                  this.var_807.deactivate();
               }
            }
            this.var_807 = param1;
