package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1217:Dictionary = createPropertySetterTable();
      ...
      protected var var_527:Number;
      
      protected var var_528:Boolean;
      ...
      private var var_390:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_390,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_390 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_390,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_715 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_390);
      }
      ...
      {
         return new Rectangle(this.var_803 * this.maxScrollH,this.var_527 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_390);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_991) ? new PropertyStruct(PropertyDefaults.const_710,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1017) : PropertyDefaults.const_1599);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1006 ? new PropertyStruct(PropertyDefaults.const_810,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1058) : PropertyDefaults.const_1513);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1072 ? new PropertyStruct(PropertyDefaults.const_1057,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1040) : PropertyDefaults.const_1602);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_681) ? new PropertyStruct(PropertyDefaults.const_369,this._field.textColor,PropertyStruct.const_143,true) : PropertyDefaults.const_1031);
         _loc1_.push(this.var_390 != TextStyleManager.const_181 ? new PropertyStruct(PropertyDefaults.const_383,this.var_390,PropertyStruct.const_51,true,PropertyDefaults.const_642) : PropertyDefaults.const_1202);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_800 ? new PropertyStruct(PropertyDefaults.const_254,this.var_40.left,PropertyStruct.const_39,true) : PropertyDefaults.const_582);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_679 ? new PropertyStruct(PropertyDefaults.const_226,this.var_40.top,PropertyStruct.const_39,true) : PropertyDefaults.const_461);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_662 ? new PropertyStruct(PropertyDefaults.const_237,this.var_40.right,PropertyStruct.const_39,true) : PropertyDefaults.const_557);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_685 ? new PropertyStruct(PropertyDefaults.const_258,this.var_40.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_509);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1041 ? new PropertyStruct(PropertyDefaults.const_829,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1391);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_267,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_267,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_267,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
