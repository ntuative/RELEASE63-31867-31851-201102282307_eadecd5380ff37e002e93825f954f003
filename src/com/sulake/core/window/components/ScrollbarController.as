package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1245:String = "increment";
      
      private static const const_1246:String = "decrement";
      
      private static const const_919:String = "slider_track";
      
      private static const const_590:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_446,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_49,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_446,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_919) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_590) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_590:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_298)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_462)
         {
            ...
            else if(param2.name == const_1246)
            {
               if(this.var_19)
               {
                  this.var_1053 = true;
            ...
            else if(param2.name == const_919)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_590).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_298)
         {
