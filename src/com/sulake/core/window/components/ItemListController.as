package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1989:Boolean = false;
      ...
      protected var var_805:Boolean;
      
      protected var var_380:Boolean;
      
      protected var var_997:Boolean;
      
      protected var var_1990:int = 0;
      
      protected var var_1991:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_805 = PropertyDefaults.const_760;
         this.var_380 = PropertyDefaults.const_789;
         this.var_997 = PropertyDefaults.const_866;
         this.var_650 = 0;
         this.var_649 = 0;
         this.var_104 = 0;
         this.var_92 = 0;
         this._horizontal = param2 == WindowType.const_405;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_163 = var_442 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_334,WindowStyle.const_754,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_515,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_287,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_540,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_997;
      }
      ...
      {
         return new Rectangle(this.var_650 * this.maxScrollH,this.var_649 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_650 = param1;
            this._container.x = -this.var_650 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_446,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_649 = param1;
            this._container.y = -this.var_649 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_446,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_559,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_515,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_287,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_201:
               if(this.var_1234)
               {
                  this.var_1232 = this.var_1990 - _loc3_;
                  this.var_1233 = this.var_1991 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1232 != 0 && this.var_104 != 0)
                     {
                        this.scrollH += this.var_1232 / this.var_104;
                     }
                  }
                  else if(this.var_1233 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1233 / this.var_92;
                  }
                  this.var_1990 = _loc3_;
                  this.var_1991 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_187:
               if(this.var_1234)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1232,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1233);
                  }
                  this.var_1234 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_805 && !this.var_530 && this._container)
         {
            this.var_530 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_368,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1173);
         }
         if(this.var_805 != PropertyDefaults.const_760)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_741,this.var_805,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1523);
         }
         if(this.var_380 != PropertyDefaults.const_789)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_668,this.var_380,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1649);
         }
         if(this.var_997 != PropertyDefaults.const_866)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_746,this.var_997,PropertyStruct.const_35,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_368:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_668:
               ...
               case PropertyDefaults.const_746:
                  ...
                  break;
               case PropertyDefaults.const_741:
                  this.var_805 = _loc2_.value as Boolean;
                  break;
            }
         }
