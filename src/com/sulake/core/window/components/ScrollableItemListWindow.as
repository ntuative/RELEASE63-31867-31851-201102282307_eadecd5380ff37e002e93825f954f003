package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_383)
         {
            this.var_383.removeEventListener(WindowEvent.const_304,this.scrollBarEventProc);
            this.var_383.removeEventListener(WindowEvent.const_256,this.scrollBarEventProc);
            this.var_383 = null;
         }
         if(this.var_1009)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1009)
         {
            this.var_1009 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_383)
         {
            ...
            if(this.var_383)
            {
               this.var_383.addEventListener(WindowEvent.const_304,this.scrollBarEventProc);
               this.var_383.addEventListener(WindowEvent.const_256,this.scrollBarEventProc);
            }
         }
         return this.var_383;
      }
