package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2771 = param3 == const_212 || param3 == const_149 || param3 == const_219 || param3 == const_271;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_271:
               ...
               break;
            case const_143:
               _loc1_ = "<var key=\"" + this.var_567 + "\" value=\"" + "0x" + uint(this.var_169).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_567 + "\" value=\"" + this.var_169 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
