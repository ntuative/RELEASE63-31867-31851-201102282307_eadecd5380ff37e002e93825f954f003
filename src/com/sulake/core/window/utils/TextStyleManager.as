package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_472:Array;
      ...
      private static const const_1235:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_472.indexOf(_loc4_.name) == -1)
            {
               var_472.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_588);
         if(countSubStrings(param1,const_589) != countSubStrings(param1,const_588))
         {
            throw new Error("Mismatching amount of \"" + const_589 + "\" versus \"" + const_588 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1236) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1235) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_589)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
