package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1042:String = "_EXCLUDE";
      
      public static const const_1859:String = "_INCLUDE";
      
      public static const const_1843:String = "_TEMP";
      
      private static const const_1287:String = "layout";
      
      private static const const_935:String = "window";
      
      private static const const_936:String = "variables";
      ...
      private static const const_1278:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1284:String = "width";
      
      private static const const_1281:String = "height";
      
      private static const const_1288:String = "visible";
      
      private static const const_1276:String = "caption";
      ...
      private static const const_1275:String = "treshold";
      
      private static const const_1279:String = "children";
      
      private static const const_1289:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1282:String = "height_min";
      
      private static const const_1283:String = "height_max";
      
      private static const const_601:String = "true";
      
      private static const const_158:String = "0";
      
      private static const const_1277:String = "$";
      ...
      private static const const_1290:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1488:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1236,this.var_1235);
         this.var_998 = new Dictionary();
         this.var_1488 = new Dictionary();
         ParamCodeTable.fillTables(this.var_998,this.var_1488);
         this.var_1992 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1290,const_47);
         return param1.replace(const_1285,const_47);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1488)
            {
               delete this.var_1488[_loc1_];
            }
            this.var_1992.dispose();
            this.var_1992 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1236[xml.localName()];
         ...
         tag = unescape(String(this.parseAttribute(xml,const_1278,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_158));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_158));
         rect.width = Number(this.parseAttribute(xml,const_1284,variables,const_158));
         rect.height = Number(this.parseAttribute(xml,const_1281,variables,const_158));
         visible = this.parseAttribute(xml,const_1288,variables,visible.toString()) == const_601;
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1276,variables,caption)));
         if(tag != const_47)
         {
            tags = tag.split(const_1280);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_936)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1282,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1283,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_601;
         blend = Number(this.parseAttribute(xml,const_1083,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1291,variables,window.clipping.toString()) == const_601;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1275,variables,window.mouseThreshold.toString()));
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1235[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1042) == -1)
                  {
