package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this._lastClickTarget = param1.var_1223 as WindowController;
         this.var_156 = param1.renderer;
         this.var_804 = param1.var_1220;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_648.x || _loc3_.stageY != this.var_648.y)
            {
               ...
               _loc6_ = new Array();
               this.var_136.groupParameterFilteredChildrenUnderPoint(this.var_648,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_83 != this.var_136 && !this.var_83.disposed)
                  {
                     ...
                     this.var_83 = WindowController(this.var_136);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_83 && !this.var_83.disposed)
                     {
                        ...
                        {
                           this.var_804.mouseEventReceived(_loc3_.type,this.var_83);
                        }
                     }
                  }
         ...
         param1.var_1223 = this._lastClickTarget;
         param1.renderer = this.var_156;
         param1.var_1220 = this.var_804;
      }
