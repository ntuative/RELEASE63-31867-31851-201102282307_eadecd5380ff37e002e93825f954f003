package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_597:Map = new Map();
      
      private static const const_330:Map = new Map();
      
      private static var var_1080:Boolean = false;
      ...
      {
         return const_597.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1080)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_597.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1080 = true;
         }
