package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerAgentTask implements IDisposable
   {
      ...
      public function stop() : void
      {
         if(this.var_665)
         {
            this.var_1909 = getTimer() - this.var_2277;
            ++this.var_1202;
            this.var_1470 += this.var_1909;
            this.var_1910 = this.var_1470 / this.var_1202;
            this.var_665 = false;
         }
      }
