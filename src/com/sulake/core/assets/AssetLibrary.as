package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_618:String = "AssetLibraryLoaded";
      
      public static const const_1400:String = "AssetLibraryUnloaded";
      
      public static const const_1656:String = "AssetLibraryLoadError";
      
      private static var var_275:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_673 = new XML();
         this.var_393 = 0;
         this.var_391 = new Array();
         if(var_275 == null)
         {
            var_275 = new Dictionary(false);
         ...
         ++var_470;
         this.var_392 = new Dictionary(false);
         this.var_471 = new Dictionary(false);
         this.var_847 = new Dictionary(false);
         this.var_140 = new Dictionary(false);
         var_846.push(this);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = true) : void
      {
         if(this._file == param1.url && this.var_848)
         {
            ...
            {
               AssetLibrary.fetchLibraryContents(this,this.var_673,this.var_556);
            }
            this.var_849 = param2;
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_471)
         {
            _loc2_ = this.var_471[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_471[_loc1_];
         }
         for(_loc1_ in this.var_140)
         {
            delete this.var_140[_loc1_];
         }
         for(_loc1_ in this.var_847)
         {
      ...
      {
         var _loc2_:Class = this.var_847[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_471[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1048,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1130,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1188,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_471[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_471[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_140[struct.assetName] == null)
                  {
                     ++this.var_393;
                     this.var_391.push(struct.assetName);
                  }
                  this.var_140[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_45,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_471[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_140[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_391.length ? this.getAssetByName(this.var_391[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_140)
         {
            if(this.var_140[_loc2_] == param1)
            {
               return this.var_391.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_140[param1] != null || (this.var_556 != null ? this.var_556[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_140[param1] == null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_275.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_275[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_392.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_392[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_275[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_392[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_275)
            {
               _loc3_ = AssetTypeDeclaration(var_275[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_392)
         {
            _loc3_ = AssetTypeDeclaration(this.var_392[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_275)
            {
               _loc4_ = AssetTypeDeclaration(var_275[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_392)
         {
            _loc4_ = AssetTypeDeclaration(this.var_392[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_673 = _loc2_.manifest.copy();
         this.var_556 = _loc2_.resource;
         ...
         this.var_848 = true;
         dispatchEvent(new Event(AssetLibrary.const_618));
         dispatchEvent(new Event(AssetLibrary.const_1117));
         if(this.var_849)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1656));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_673.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_556[param1]);
