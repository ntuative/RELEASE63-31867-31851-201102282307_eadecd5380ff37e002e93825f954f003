package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_953:uint = 11;
      ...
      private var var_1133:IHabboWindowManager;
      ...
      private var var_614:FramerateTracker = null;
      
      private var var_250:LatencyTracker = null;
      
      private var var_613:LagWarningLogger = null;
      
      private var var_615:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_614 = new FramerateTracker();
         this.var_250 = new LatencyTracker();
         this.var_613 = new LagWarningLogger();
         this.var_615 = new ToolbarClickTracker(this);
         this.var_1416 = new Array(const_953);
         var _loc4_:int = 0;
         while(_loc4_ < const_953)
         {
            this.var_1416[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1520,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1445,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1476,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_887,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1139,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1133)
            {
               this.var_1133.release(new IIDHabboWindowManager());
               this.var_1133 = null;
            }
            if(this.var_277)
            {
            ...
            if(this.var_193)
            {
               if(!this.var_193.disposed)
               {
                  ...
                  Component(this.var_193).events.removeEventListener(HabboFriendListTrackingEvent.const_402,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_171)
            {
               ...
               {
                  this.var_171.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_176)
         {
            if(this.var_250 != null)
            {
               this.var_250.configuration = this.var_176;
            }
            if(this.var_249 != null)
            {
               this.var_249.configuration = this.var_176;
            }
            ...
            if(this.var_176)
            {
               ...
               {
                  this.var_613.configure(this.var_176);
               }
               if(this.var_614 != null)
               {
                  this.var_614.configure(this.var_176);
               }
               if(this.var_615 != null)
               {
                  this.var_615.configure(this.var_176);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_632,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_901,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_428,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_613 != null)
            {
               this.var_613.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_901)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1591);
         }
         else if(param1.type == HabboHotelViewEvent.const_428)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1568);
         }
         else if(param1.type == HabboHotelViewEvent.const_71)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1364);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_632:
               this.trackLoginStep(HabboLoginTrackingStep.const_1535,String(this._communication.port));
               break;
      ...
      {
         this.var_1133 = IHabboWindowManager(param2);
         if(this.var_1133)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.method_9 && !this._crashed)
         {
            this._crashed = true;
            ...
            if(this.var_176)
            {
               if(this.var_176.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1416)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1215);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1215,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_193).events.addEventListener(HabboFriendListTrackingEvent.const_402,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1139,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_887,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_277.events.addEventListener(AdEvent.const_548,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_171 = param2 as IHabboToolbar;
         this.var_171.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_615)
         {
            this.var_615.track(param1.iconName);
         }
      }
      ...
      {
         this.var_613.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1795;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1795);
         }
         ...
         if(this.var_249 != null)
         {
            this.var_249.update(param1,this.var_504);
         }
         if(this.var_250 != null)
         {
            this.var_250.update(param1,this.var_504);
         }
         if(this.var_614 != null)
         {
            this.var_614.trackUpdate(param1,this,this.var_504);
         }
         if(this.var_613 != null)
         {
            this.var_613.update(this.var_504);
         }
      }
   }
}
