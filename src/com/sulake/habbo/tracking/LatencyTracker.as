package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1872 = int(this.var_176.getKey("latencytest.interval"));
         this.var_1870 = int(this.var_176.getKey("latencytest.report.index"));
         this.var_2638 = int(this.var_176.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1871 > this.var_1872)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1871 = getTimer();
         this.var_632.add(this.var_1450,this.var_1871);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1450));
         ++this.var_1450;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_632 == null || this.var_222 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_632.getValue(_loc2_.requestId);
         this.var_632.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_222.push(_loc4_);
         if(this.var_222.length == this.var_1870 && this.var_1870 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1873) > this.var_2638 || this.var_1873 == 0)
            {
               this.var_1873 = _loc9_;
