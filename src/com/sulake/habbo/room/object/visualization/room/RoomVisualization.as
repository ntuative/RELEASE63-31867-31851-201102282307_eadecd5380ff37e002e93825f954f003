package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1637:int = 16777215;
      
      public static const const_1371:int = 13421772;
      
      private static const const_961:int = 16777215;
      
      private static const const_962:int = 13421772;
      ...
      public static const const_1578:int = 13421772;
      
      public static const const_1625:int = 10066329;
      ...
      private var var_510:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2589:int = 255;
      
      private var var_2585:int = 255;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_510 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1122);
            ...
            while(_loc9_ < this.var_363.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_95)
               {
                  if(this.var_1833)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2585 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2589 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2588 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1627)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1431 || _loc3_.y != this.var_2586 || _loc3_.z != this.var_2583 || param1.scale != this.var_2587))
            {
               this.var_1431 = _loc3_.x;
               this.var_2586 = _loc3_.y;
               this.var_2583 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2584)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2584 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_763));
            if(_loc4_ != this.var_1152)
            {
               this.var_1152 = _loc4_;
               this.var_2585 = this.var_1152 & 255;
               this.var_2589 = this.var_1152 >> 8 & 255;
               this.var_2588 = this.var_1152 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1020));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_818);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_888);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_716);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_783));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_824));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_900));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1683;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_510.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_510.maskCount)
         {
            _loc10_ = this.var_510.getMaskType(_loc8_);
            _loc11_ = this.var_510.getMaskLocation(_loc8_);
            _loc12_ = this.var_510.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_121.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_95)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_95 && _loc12_ == RoomPlaneBitmapMaskData.const_264)
                              {
