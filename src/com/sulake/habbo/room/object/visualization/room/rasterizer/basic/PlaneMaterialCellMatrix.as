package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1645:int = const_404;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_675 != null)
         {
            this.var_675.assign(new Vector3d());
         }
         this.var_558 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this.var_675,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_558,param6,param7);
                     return param1;
                  }
                  return this.var_29;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1588 == const_113)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_558);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_558,this.var_29.width,this.var_558);
         }
