package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_1815:int = 16777216;
      
      private var var_2784:int = 69069;
      
      private var var_2785:int = 5;
      ...
      {
         var _loc1_:int = this.var_2784 * this.var_1814 + this.var_2785;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1815;
         this.var_1814 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1815 * param2);
      }
   }
}
