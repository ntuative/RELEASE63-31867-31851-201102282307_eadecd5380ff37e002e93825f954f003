package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_959:int = 1000;
      
      private static const const_1334:String = "pet_experience_bubble_png";
      
      private static const const_1332:int = 0;
      
      private static const const_1333:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this.var_280.commonAssets.getAssetByName(const_1334) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_367);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_262);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_352) > 0;
            this.var_1702 = _loc3_.getNumber(RoomObjectVariableEnum.const_317);
            this.var_1422 = _loc3_.getNumber(RoomObjectVariableEnum.const_788);
            this.var_2077 = _loc3_.getNumber(RoomObjectVariableEnum.const_637);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1811)
            {
               this.var_1811 = _loc6_;
               this.var_2551 = this.var_1811.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1422 > 0)
            {
               ...
               if(_loc2_ < const_959)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_959 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_236 = param1;
            _loc3_ = this.var_280.getAnimationForPosture(var_182,param1);
            this.setAnimationForIndex(const_1332,_loc3_);
         }
         if(param2 != this.var_1355)
         {
            this.var_1355 = param2;
            _loc3_ = this.var_280.getAnimationForGesture(var_182,param2);
            this.setAnimationForIndex(const_1333,_loc3_);
         }
      }
      ...
      override protected function updateAnimations(param1:Number) : Array
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_114.length)
         {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2551);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_608)
         {
            ...
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_574.length)
               {
                  return null;
               }
