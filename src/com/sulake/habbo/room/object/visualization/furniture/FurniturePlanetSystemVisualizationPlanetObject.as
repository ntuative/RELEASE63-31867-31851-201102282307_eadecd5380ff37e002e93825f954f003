package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1340:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2569 = param4 * 0 * 2 / 360;
         this.var_1817 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1145 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1145 += this.var_2569 / const_1340;
      ...
      {
         var _loc3_:Number = this.var_1253 * Math.cos(this.var_1145 + this.var_1817);
         var _loc4_:Number = this.var_1253 * Math.sin(this.var_1145 + this.var_1817);
