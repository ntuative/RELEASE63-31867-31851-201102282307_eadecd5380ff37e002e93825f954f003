package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1346:String = "shore";
      ...
      {
         if(this.var_2616 == param1 && this.var_2615 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1346)
            {
               this.var_1850 = _loc2_;
               this.var_2616 = param1;
               this.var_2615 = _direction;
               return this.var_1850;
            }
            _loc2_--;
         }
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_630[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_630[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_515 == 0 || this.var_631 == 0)
         {
            ...
            this.var_515 = _loc2_.getNumber(RoomObjectVariableEnum.const_327);
            this.var_631 = _loc2_.getNumber(RoomObjectVariableEnum.const_390);
         }
         this.var_427 = [];
         this.var_630 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_515 * 2 + this.var_631 * 2)
         {
            this.var_427.push(false);
            this.var_630.push(ShoreMaskCreatorUtility.const_75);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_69,getSize(param3),this.var_427,this.var_630,assetCollection);
      }
