   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(this.usesAnimationResetting())
                  {
                     ...
                     if(_loc4_ > this.var_1621)
                     {
                        this.var_1621 = _loc4_;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this.var_280.isImmediateChange(this.var_863,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this.var_280.hasAnimation(this.var_863,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_109 != null)
         {
            this.var_109.setLayerCount(this.var_624);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_863 = param1;
            this.var_624 = this.var_280.getLayerCount(param1);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_980)
                  {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_433)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
