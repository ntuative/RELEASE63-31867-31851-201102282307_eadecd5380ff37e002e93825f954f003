package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1576:String = "cone";
      
      public static const const_1429:String = "plane";
      
      public static const const_1414:String = "sphere";
      ...
      private var var_961:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_962 = 0;
         this.var_811 = false;
         this.init(0,0,0,this._direction,this.var_2624,this.var_961,this.var_2627,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1172.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_811 = true;
         if(this.var_962 < this.var_1445)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2625)
         {
            switch(this.var_2622)
            {
               case const_1576:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_961,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1172.length);
         return this.var_1172[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_962 < this.var_1445)
         {
            if(this.age % this.var_2623 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_962 < this.var_1445)
         {
            ...
            this.y = (2 - this.var_258) * this.y - (1 - this.var_258) * this.lastY + this.var_1858 * this.var_961 * this.var_961;
         ...
         for each(_loc2_ in this.var_364)
         {
            ...
            _loc2_.y = (2 - this.var_258) * _loc2_.y - (1 - this.var_258) * _loc2_.lastY + this.var_1858 * this.var_961 * this.var_961;
