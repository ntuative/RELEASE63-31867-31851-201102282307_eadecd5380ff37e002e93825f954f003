package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_422:int = 2;
      
      private static const const_969:int = 15;
      
      private static const const_970:int = 31;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1191[param2];
         var _loc4_:int = this.var_1192[param2];
         var _loc5_:int = this.var_1190[param2];
         var _loc6_:Number = this.var_1189[param2];
         if(param1 == 32)
         {
            _loc7_ = const_969;
         }
         ...
         this.var_1191[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1189[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1191.push(Math.random() * _loc2_ * 1.5);
         this.var_1191.push(Math.random() * _loc2_ * 1.5);
         this.var_1192 = new Array();
         this.var_1192.push(1);
         this.var_1192.push(-1);
         this.var_1190 = new Array();
         this.var_1190.push(const_1351);
         this.var_1190.push(ANIM_SPEED_SLOW);
         this.var_1189 = new Array();
         this.var_1189.push(this.getRandomAmplitudeFactor());
         this.var_1189.push(this.getRandomAmplitudeFactor());
      }
