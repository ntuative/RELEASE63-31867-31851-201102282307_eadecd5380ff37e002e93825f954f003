package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_918:int = 0;
      
      private static const const_1674:int = 1;
      
      private static const const_917:int = 10;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1595.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1595).length == 0)
            {
               if(object.getState(0) != const_918)
               {
                  object.setState(const_918,0);
               }
            }
         }
      }
