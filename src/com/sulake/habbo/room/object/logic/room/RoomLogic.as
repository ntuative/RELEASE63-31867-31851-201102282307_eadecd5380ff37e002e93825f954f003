package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1752:int = 255;
      
      private var var_1122:uint = 16777215;
      
      private var var_1753:int = 255;
      
      private var var_1123:int = 0;
      
      private var var_1750:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1122,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_763,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_783,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_824,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_900,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1123)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1751;
            if(_loc2_ - this.var_1123 >= this.var_1750)
            {
               _loc3_ = this.var_1122;
               _loc4_ = this.var_1753;
               this.var_1123 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1122 >> 16 & 255;
               _loc11_ = this.var_1122 >> 8 & 255;
               _loc12_ = this.var_1122 & 255;
               _loc13_ = (_loc2_ - this.var_1123) / this.var_1750;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1752 + (this.var_1753 - this.var_1752) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_763,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_870:
               param2.setString(RoomObjectVariableEnum.const_888,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_614:
               param2.setString(RoomObjectVariableEnum.const_818,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_898:
               param2.setString(RoomObjectVariableEnum.const_716,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_443:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_264)
               {
                  _loc5_ = "null";
               }
               this.var_510.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_675:
               _loc4_ = this.var_510.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_510.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1100,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_988:
               param2.setNumber(RoomObjectVariableEnum.const_783,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_990:
               param2.setNumber(RoomObjectVariableEnum.const_824,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_900,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1020,int(param1.bgOnly));
         this.var_1391 = this._color;
         this.var_1752 = this.var_1751;
         this.var_1122 = _loc3_;
         this.var_1753 = _loc4_;
         this.var_1123 = getTimer();
         this.var_1750 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1612,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1533,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1370,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_197)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_156 || _loc13_ == RoomPlaneData.const_278)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
