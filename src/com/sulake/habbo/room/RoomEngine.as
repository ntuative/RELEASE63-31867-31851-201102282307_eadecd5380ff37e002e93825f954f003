package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1230:String = "tile_cursor";
      
      private static const const_913:int = -3;
      
      private static const const_1229:String = "selection_arrow";
      
      private static const const_911:String = "overlay";
      
      private static const const_328:String = "object_icon_sprite";
      
      private static const const_413:int = 15;
      ...
      private var var_834:IRoomRendererFactory = null;
      ...
      private var var_401:ISessionDataManager = null;
      ...
      private var var_666:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_666 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_834.release(new IIDRoomRendererFactory());
            this.var_834 = null;
         }
      ...
      {
         var _loc3_:String = this.method_1(param1,param2);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_46 != null)
         {
            ...
            _loc2_ = this.var_46.getRoom(this.method_1(this.var_97,this.var_98));
         ...
         while(_loc2_ < this.var_323.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_97 || _loc6_ != this.var_98 || !this.var_1026)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_845) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_708) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_903) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_633) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_474;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_46 != null)
         {
            ...
            this.var_46.addObjectUpdateCategory(RoomObjectCategoryEnum.const_80);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_834 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_875,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_875)
         {
            this.var_2118 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_277.events.addEventListener(AdEvent.const_548,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_401;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_24 != null)
         {
            ...
            {
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_257,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_529,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_570,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_146,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_784,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_569,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_437,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_496,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_283,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_427,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_469,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_1170,this.roomObjectEventHandler);
      ...
      {
         if(this.var_24 == null || this.var_474 == null || this.var_46 == null || this.var_834 == null || this._communication == null || this.var_143 == null || !this.var_2118)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_462 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_696,0,0));
            _loc2_ = 0;
      ...
      public function method_1(param1:int, param2:int) : String
      {
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1142,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_687,1,true);
            _loc13_ = parseInt(this.var_143.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1061,_loc13_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_329,const_585,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_687,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_869,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_845,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_903,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_708,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_633,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1129,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_870,param3);
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_898,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_443,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_264);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_892,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_883,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_892,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1204,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1094,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_912,const_1230,RoomObjectCategoryEnum.const_316);
         if(this.var_143.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_913,const_1229,RoomObjectCategoryEnum.const_316);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.method_1(param1,param2),const_329,RoomObjectCategoryEnum.const_80);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            _loc8_ = this.method_1(param1,param2);
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_870,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_898,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1415,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_990,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_988,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_822,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc18_:* = null;
         var _loc19_:* = null;
         var _loc7_:String = this.method_1(param1,param2);
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_834.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1134;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_869);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_883);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_892);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1204);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1094);
      ...
      {
         var _loc8_:int = param2 - this.var_1277;
         var _loc9_:int = param3 - this.var_1278;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1026 = true;
               this.var_835 = false;
               this.var_2116 = this.var_1277;
               this.var_2117 = this.var_1278;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1026)
            {
               if(!this.var_835)
               {
                  _loc8_ = param2 - this.var_2116;
                  _loc9_ = param3 - this.var_2117;
                  if(_loc8_ <= -const_413 || _loc8_ >= const_413 || _loc9_ <= -const_413 || _loc9_ >= const_413)
                  {
                     this.var_835 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_328);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_475,this.var_97,this.var_98,-1,RoomObjectCategoryEnum.const_165));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_72 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_329,const_585);
                     this.var_72.handleRoomObjectEvent(_loc14_,this.var_97,this.var_98);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_911) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1276);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_328);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_328,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1277 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1278 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1276);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_328);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1276);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_328);
         }
      }
      ...
      public function getRoomObject(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc5_:String = this.method_1(param1,param2);
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_72 != null)
         {
            return this.var_72.modifyRoomObject(this.var_97,this.var_98,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_72 != null)
         {
            ...
            {
               return this.var_72.modifyWallItemData(this.var_97,this.var_98,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_72 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_72.deleteWallItem(this.var_97,this.var_98,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_687) != 0)
         {
            return false;
         }
         if(this.var_72 != null)
         {
            return this.var_72.initializeRoomObjectInsert(this.var_97,this.var_98,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_72 != null)
         {
            this.var_72.cancelRoomObjectInsert(this.var_97,this.var_98);
         }
      }
      ...
      {
         return this.getObject(this.method_1(param1,param2),const_913,RoomObjectCategoryEnum.const_316);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.method_1(param1,param2),const_912,RoomObjectCategoryEnum.const_316);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_395,_loc13_,true);
      ...
      {
         var _loc5_:int = 0;
         return this.createObject(this.method_1(param1,param2),param3,param4,_loc5_);
      }
      
      private function getObjectFurniture(param1:int, param2:int, param3:int) : IRoomObjectController
      {
         return this.getObject(this.method_1(param1,param2),param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
      
      public function disposeObjectFurniture(param1:int, param2:int, param3:int) : void
      {
         this.disposeObject(this.method_1(param1,param2),param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_395,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1134,1,true);
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1158) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1193);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_443,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_675,_loc5_);
                  }
               }
            }
         }
      ...
      {
         return this.getObject(this.method_1(param1,param2),param3,RoomObjectCategoryEnum.const_27);
      }
      
      public function disposeObjectWallItem(param1:int, param2:int, param3:int) : void
      {
         this.disposeObject(this.method_1(param1,param2),param3,RoomObjectCategoryEnum.const_27);
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_317);
         }
      ...
      {
         return this.getObject(this.method_1(param1,param2),param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER);
      }
      
      public function disposeObjectUser(param1:int, param2:int, param3:int) : void
      {
         this.disposeObject(this.method_1(param1,param2),param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER);
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_791,this.var_97,this.var_98,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_72 != null)
         {
            this.var_72.handleRoomObjectEvent(param1,this.var_97,this.var_98);
         }
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc9_:* = null;
         var _loc10_:String = "";
         var _loc12_:String = this.method_1(param1,param2);
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_543);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_888,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_818,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_716,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_443,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc12_:int = this.var_666.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_252,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_543,param7);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
         ...
         {
            this.var_1025.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1115,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_666.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_97,this.var_98,const_329,RoomObjectCategoryEnum.const_80,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1115);
               ...
               this.var_666.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1025.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1126,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_976,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1189,RoomObjectVariableEnum.const_389,param1.clickUrl);
