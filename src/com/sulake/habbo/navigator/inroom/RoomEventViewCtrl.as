package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2687:ITextWindow;
      ...
      private var var_2688:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1905.visible = true;
         this.var_2687.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_781.setText(param1.eventDescription);
         this.var_980.setText(this.getTagFromEvent(param1,1));
         this.var_981.setText(this.getTagFromEvent(param1,2));
         this.var_1464.visible = false;
         this.var_1463.visible = true;
         this.var_1465.visible = true;
         this.var_1906.visible = false;
         this.var_1904.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_979.visible = true;
         this.var_1905.visible = false;
         this.var_1464.visible = true;
         this.var_1463.visible = false;
         this.var_1465.visible = false;
         this.var_781.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_980.goBackToInitialState();
         this.var_981.goBackToInitialState();
         this.var_979.selection = 0;
         this.var_1906.visible = true;
         this.var_1904.visible = false;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_781.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_980.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_781.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1905 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2687 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1906 = ITextWindow(this.find("create_caption"));
            this.var_1904 = ITextWindow(this.find("edit_caption"));
            this.var_1464 = IButtonWindow(this.find("create_button"));
            this.var_1463 = IButtonWindow(this.find("edit_button"));
            this.var_2688 = IButtonWindow(this.find("cancel_button"));
            this.var_1465 = IButtonWindow(this.find("end_button"));
            this.var_979 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1464,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1463,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1465,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2688,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_781 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
