package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_642:ICheckBoxWindow;
      ...
      private var var_2703:ITextWindow;
      ...
      {
         this.var_371 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_371));
      ...
      {
         if(param1 != this.var_371 || this.var_1211 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1211 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1381)
         {
            this.var_792.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1588)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_571,this.onDoorModePasswordSelect);
         ...
         this.var_1207 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         ...
         this.var_1205 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_642 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1917 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1473 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1210 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1206 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1919 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1474 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_264 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1208 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2702 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2703 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1916 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1916.procedure = this.onSwitchView;
         this.var_1208.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1917.visible = this._inRoom;
         this.var_1919.visible = this._inRoom;
         this.var_2703.visible = this.var_522;
         this.var_2702.visible = !this.var_522;
         if(this.var_522)
         {
         ...
         else
         {
            ...
            this.var_1473.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1473.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1210.height = Util.getLowestPoint(this.var_1210) + 4;
         }
         this.var_1916.text = !!this.var_522 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1917.name,this.var_1473.name,this.var_1210.name,this.var_1206.name,this.var_1474.name,this.var_1919.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowWalkThrough = this.var_1205.isSelected;
         _loc2_.hideWalls = this.var_642.isSelected;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_371);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_80.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_371]);
         _loc2_.show();
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_371));
      }
