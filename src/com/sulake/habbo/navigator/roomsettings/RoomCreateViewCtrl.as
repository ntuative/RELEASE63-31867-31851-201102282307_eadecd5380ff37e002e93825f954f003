package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_566 = new Timer(100);
         this.var_566.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_566)
         {
            this.var_566.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_566.reset();
            this.var_566 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1619 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1619 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1060 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_168.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1060.goBackToInitialState();
         this.var_1060.input.textBackgroundColor = 4294967295;
         this.var_1061 = this.var_43[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_60,HabboWindowStyle.const_31,HabboWindowParam.const_61,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1060.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1060.getText();
         var _loc3_:String = "model_" + this.var_1061.name;
