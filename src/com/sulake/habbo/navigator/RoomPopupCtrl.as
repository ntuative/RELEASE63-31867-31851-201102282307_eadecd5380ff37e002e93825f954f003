package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2531 = new RoomThumbnailRenderer(param1);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1075.refreshTags(_loc1_,this.var_113.tags);
         ...
         this.var_2531.refreshThumbnail(_loc1_,this.var_113.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_251,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
