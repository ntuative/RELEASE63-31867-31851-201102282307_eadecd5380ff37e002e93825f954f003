package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_951:int = 0;
      ...
      {
         return this.var_608 != const_951;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1764 != RecyclerStatusMessageEvent.const_1212;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_608 == const_419;
      }
      ...
      {
         this.var_608 = const_952;
         this.var_111 = new Array(const_199);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1764)
         {
            case RecyclerStatusMessageEvent.const_1459:
               this.var_608 = const_419;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1171:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1603:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_111.length < const_199)
         {
            return false;
         }
         var _loc1_:int = 0;
