package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      {
         return this.var_401.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_401.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = this.var_401.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_100.getActivityPointsForType(Purse.const_172)));
         var _loc1_:int = 0;
      ...
      {
         this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_682)
         {
            if(!this.var_401.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_259,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_84:
               this.var_1716 = param1.session.isPrivateRoom;
               if(this.var_90 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1107 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_711 && this.var_711 != "")
         {
            this.var_349.openPage(this.var_711);
            this.var_711 = "";
            this.var_905 = -1;
         }
         else if(this.var_905 > -1)
         {
            this.var_349.openPageById(this.var_905,this.var_1715);
            this.var_905 = -1;
            this.var_1715 = -1;
            this.var_711 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2410 && this.var_590 != null)
         {
            this.var_590.playSound(HabboSoundTypesEnum.const_1109);
         }
         this.var_2410 = false;
         if(this.var_285 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2412 && this.var_590 != null)
         {
            this.var_590.playSound(HabboSoundTypesEnum.const_982);
         }
         this.var_2412 = false;
         if(this.var_285 != null)
         {
         ...
         if(_loc2_.type == Purse.const_172)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1107.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_284.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
