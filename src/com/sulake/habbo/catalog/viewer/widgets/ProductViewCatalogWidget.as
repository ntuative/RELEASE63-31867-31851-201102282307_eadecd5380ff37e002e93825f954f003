package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1335:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_882 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1094 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1671 = new Point(this.var_86.x,this.var_86.y);
         this.var_484 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1335 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_882.text = _loc4_;
         this.var_1094.text = _loc5_;
         this.var_882.height = this.var_882.textHeight + 5;
         this.var_1094.y = this.var_882.y + this.var_882.height;
         this.var_1094.height = Math.max(130,this.var_1094.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_453:
                  ...
                  if(this.var_484 != null)
                  {
                     ...
                     _loc10_.populateItemGrid(this.var_484,this.var_1335,this.var_1597);
                     this.var_484.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_272:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_305,AvatarAction.const_432);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1671.x;
            this.var_86.y = this.var_1671.y;
            if(param3 != null)
            {
