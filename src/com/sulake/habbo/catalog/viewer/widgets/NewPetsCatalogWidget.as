package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1231:int = 18;
      ...
      private var var_188:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_463 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_463 < 8)
         {
            return false;
         }
         ...
         if(this.var_188 != null && this.var_188.length > 0)
         {
            this.var_325 = this.var_188[0];
         }
         else
         {
            this.var_325 = -1;
         }
         this._offers.add(this.var_463,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_188 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1231 && _loc2_ < this.var_188.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_463,this.var_188[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_188 != null && this.var_188.length > 0)
         {
            ...
            this.var_325 = this.var_188[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_463,this.var_325),this.getRaceLocalizationKey(this.var_463,this.var_325));
            }
         }
         return this.getRaceLocalizationKey(this.var_463,this.var_325);
      }
