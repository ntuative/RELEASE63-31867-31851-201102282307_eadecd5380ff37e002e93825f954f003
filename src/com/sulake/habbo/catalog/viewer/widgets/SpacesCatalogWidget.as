package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1693:String = "default";
      ...
      private var var_1694:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1348[this.var_403];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1693);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1347[this.var_404];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1349[this.var_406];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1694);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_896[this.var_403];
         for each(_loc1_ in this.var_176.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_405 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_405];
                  if(_loc9_ != null)
                  {
                     this.var_1693 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_404];
         for each(_loc1_ in this.var_176.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_487];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1347[this.var_404];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_897[this.var_406];
         for each(_loc1_ in this.var_176.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               ...
               if(_loc13_ != null)
               {
                  this.var_1694 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1349[this.var_406];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_209:
               ...
               if(this.var_403 < 0)
               {
                  this.var_403 = this.var_896.length - 1;
               }
               if(this.var_403 == this.var_896.length)
               {
                  this.var_403 = 0;
               }
               this.var_405 = 0;
               this.var_895 = 0;
               _loc5_ = this.var_896[this.var_403];
               for each(_loc8_ in this.var_176.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_895 = _loc8_.children().length();
                  }
               }
            ...
            case const_210:
               ...
               if(this.var_404 < 0)
               {
                  this.var_404 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_404 >= this._activeFloorPatterns.length)
               {
                  this.var_404 = 0;
               }
               this.var_487 = 0;
               this.var_894 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_404];
               for each(_loc9_ in this.var_176.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_894 = _loc9_.children().length();
                  }
               }
            ...
            case const_95:
               ...
               if(this.var_406 < 0)
               {
                  this.var_406 = this.var_897.length - 1;
               }
               if(this.var_406 >= this.var_897.length)
               {
                  this.var_406 = 0;
               }
               this.var_486 = 0;
               this.var_893 = 0;
               _loc7_ = this.var_897[this.var_406];
               for each(_loc10_ in this.var_176.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_893 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1693,this.var_1694,64,this,"window_romantic_wide");
         ...
         {
            this.var_1691 = _loc2_.id;
            this.var_1692 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_345 != null && this.var_344 != null)
         {
            this.setRoomImage(this.var_345,this.var_344);
         }
      }
   }
}
