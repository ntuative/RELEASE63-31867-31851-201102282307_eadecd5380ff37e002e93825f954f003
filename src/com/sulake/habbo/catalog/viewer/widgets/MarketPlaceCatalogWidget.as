package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1685:int = 1;
      
      private const const_1686:int = 2;
      
      private const const_1980:int = 40;
      
      private const const_1979:int = 10;
      
      private var var_718:Array;
      
      private var var_1375:MarketPlaceOfferData;
      ...
      public function updateStats() : void
      {
         ...
         if(_loc3_)
         {
            this.marketPlace.localization.registerParameter("catalog.marketplace.offer_details.offer_count","count",_loc1_.method_3.toString());
            _loc3_.visible = true;
         }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_596)
         {
            ...
            this.var_596 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_596)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1686,_loc2_.length);
         if(!this.var_492)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1115 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1115));
            ++this.var_1115;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_596 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_596.clone() as IWindowContainer;
         ...
         if(_loc6_)
         {
            ...
            _loc8_ = _loc8_.replace("%count%",param1.method_3);
            _loc6_.text = _loc8_;
         }
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1685);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_103)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1979;
                  break;
               case "search_input":
                  _loc8_ = this.const_1980;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1375.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_58)
