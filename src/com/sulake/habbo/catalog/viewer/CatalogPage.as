package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1668:String = "ctlg_";
       
      
      protected var var_1998:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1051:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1668 + param1;
         ...
         this.var_1998 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1998) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            ...
            case CatalogWidgetEnum.const_1550:
               ...
               break;
            case CatalogWidgetEnum.const_1408:
            ...
            case CatalogWidgetEnum.const_1492:
               ...
               break;
            case CatalogWidgetEnum.const_1403:
