package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2809:String = "magic.credits";
      
      private var var_2768:String = "magic.pixels";
      
      private var var_2767:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2768);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2767,true);
      }
