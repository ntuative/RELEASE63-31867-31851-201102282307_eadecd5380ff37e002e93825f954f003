package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this.var_33.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_371));
         Logger.log("BEGINNING TO SHOW: " + this.var_371);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1497;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_371);
         if(param1.flatId != this.var_371)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_371);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1130 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1130);
         this.var_1130.procedure = this.onSelectTemplate;
         this.var_927 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1407 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1406 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1478,_loc2_,this.var_456.text,"",""));
         if(this.var_1407.isSelected || this.var_1406.isSelected || this.var_927.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1407.isSelected,this.var_1406.isSelected,this.var_927.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1657);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1130.selection];
         if(_loc3_ != null)
         {
            this.var_539 = false;
            this.var_456.text = _loc3_;
         }
      }
   }
}
