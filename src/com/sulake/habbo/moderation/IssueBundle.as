package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_780:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2257 = param2.pickerUserId;
         this.var_2686 = param2.pickerUserName;
         this.var_1394 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_780 == null || param1.timeStamp < this.var_780.timeStamp)
         {
            this.var_780 = param1;
         }
         if(this.var_779 == null || param1.priority > this.var_779.timeStamp)
         {
            this.var_779 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_779;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_780;
         if(_loc2_ == null)
         {
