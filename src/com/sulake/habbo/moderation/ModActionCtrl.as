package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1013:IDropMenuWindow;
      ...
      private var var_819:OffenceCategoryData;
      
      private var var_820:OffenceData;
      
      private var var_1012:IButtonWindow;
      
      private var var_1011:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1012 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1011 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1524;
         ...
         this.var_456 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_456.procedure = this.onInputClick;
         this.var_1013 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1013);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_819 != null;
         ...
         else if(this.var_819 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_819.offences,this.var_1012,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1011,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1256,this.var_456.text,this.var_1257));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_819 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_820 = this.var_819.offences[_loc3_];
         this.var_456.text = this.var_820.msg;
         this.var_539 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1256,this.var_456.text,this.var_1257));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1013.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1256,this.var_456.text,this.getBanLength(),this.var_1257));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_539 || this.var_456.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1013.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1012.destroy();
            this.var_1012 = null;
         }
         if(this.var_1011 != null)
         {
            this.var_1011.destroy();
            this.var_1011 = null;
         }
         this.var_1013 = null;
         this.var_456 = null;
