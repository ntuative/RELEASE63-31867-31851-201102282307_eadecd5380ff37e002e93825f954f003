package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1995:String = "open_issues";
      
      private const const_1994:String = "picked_issues";
      ...
      private var var_1821:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_362.view.width = this.var_253.container.width;
         this.var_362.view.height = this.var_253.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1993:
               ...
               {
                  this.var_1823 = new MyIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1823;
            case this.const_1995:
               if(this.var_1822 == null)
               {
                  this.var_1822 = new OpenIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1822;
            case this.const_1994:
               if(this.var_1821 == null)
               {
                  this.var_1821 = new PickedIssuesView(this.issueManager,this,this.var_253.container);
               }
