package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1788:int = 1000;
      
      private static var var_932:Array = [];
      
      private static var var_1787:int = 200;
      ...
      private var var_1677:IMessageComposer;
      ...
      {
         this.var_734 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_733 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1677);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1413.getValue(param2.chatterName))
            {
               this.var_1413.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1413.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1414)
         {
