package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_845:Array = [];
      
      private static var var_1575:int = 200;
      ...
      {
         this.var_672 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1427;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_845.pop() as IWindowContainer;
         }
