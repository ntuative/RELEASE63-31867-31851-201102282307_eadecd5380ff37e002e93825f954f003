package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_986:String = "issue_bundle_open";
      
      public static const const_756:String = "issue_bundle_my";
      
      public static const const_1184:String = "issue_bundle_picked";
      
      public static const const_1432:int = 15000;
       
      
      private var var_64:ModerationManager;
      
      private var var_625:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_625 = new IssueBrowser(this,this.var_64.windowManager,this.var_64.assets);
         this.var_1153 = [];
         this.var_1154 = [];
         this.var_949 = new Map();
         this.var_2591 = parseInt(this.var_64.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1835 = new Timer(const_1432,0);
         this.var_1835.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1835.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1153 = this.var_1153.concat(_loc4_.getIssueIds());
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_625 == null || !this.var_625.isOpen())
         {
            this.var_64.soundManager.playSound(HabboSoundTypesEnum.const_1028);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1605)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_756);
            _loc7_ = false;
      ...
      {
         var _loc2_:IssueHandler = this.var_949.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_949.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_949.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_949.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_949.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
