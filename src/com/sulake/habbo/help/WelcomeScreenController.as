package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager, param3:IHabboConfigurationManager)
      {
         ...
         this._config = param3;
         this.var_179.toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         var _loc4_:Boolean = Boolean(parseInt(this._config.getKey("new.identity","0")));
         this.var_1583 = Boolean(parseInt(this._config.getKey("welcome.screen.enabled","0"))) && _loc4_;
         this.var_2433 = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_338 = new Point(72,10);
         this.var_194 = new Timer(this.var_2433,1);
      ...
      {
         var _loc2_:XmlAsset = this.var_179.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc4_:BitmapDataAsset = this.var_179.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc5_.content.setParamFlag(WindowParam.const_279,false);
         _loc5_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_98,HabboToolbarIconEnum.NAVIGATOR);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_179.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_338);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_338,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_338.x;
            this._window.y = this.var_338.y;
