package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_328 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102282302));
         this.var_171 = param5;
         this.var_107 = new Map();
         this.var_107.add(HabboHelpViewEnum.const_1539,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_190,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_577,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_318,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_255,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_366,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_745,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_245,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_107.add(HabboHelpViewEnum.const_1113,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_107.add(HabboHelpViewEnum.const_1118,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_849,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_469.length == 0 || param1 != this.var_328)
            {
               this.var_469.push(this.var_328);
            }
         }
         this.var_328 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_328);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_245:
               this.showUI(HabboHelpViewEnum.const_245);
               break;
            case CallForHelpResultEnum.const_1064:
               this.showUI(HabboHelpViewEnum.const_1118);
               break;
            case CallForHelpResultEnum.const_1198:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_107.getValue(HabboHelpViewEnum.const_190) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_438));
      }
      ...
      {
         return this.var_107.getValue(this.var_328);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2152 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2151;
         this._window.width = _loc1_.width + this.var_2152;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_469.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_328 == HabboHelpViewEnum.const_190)
         {
            return;
         }
         if(this.var_555.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_555.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_555.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_327.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_555[1],this.var_555[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_555[0],this.var_555[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_328 == HabboHelpViewEnum.const_190 || this.var_469.length == 0)
         {
            return;
         }
         if(this.var_327 == null)
         {
            ...
            this.var_327 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_327.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_327.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_327 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_327 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_327 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
