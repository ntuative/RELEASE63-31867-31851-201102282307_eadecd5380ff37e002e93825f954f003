package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1335:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1335)
         {
      ...
      {
         main.showUI(HabboHelpViewEnum.const_577);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            main.tellUI(HabboHelpViewEnum.const_255,_loc6_);
         }
      }
   }
}
