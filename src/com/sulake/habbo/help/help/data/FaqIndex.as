package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_748 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_750 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_749 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_154 != null)
         {
            ...
            {
               _loc2_ = this.var_154.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_154.getValue(param1);
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         {
            _loc4_ = this.var_154.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_154.length)
         {
            _loc3_ = this.var_154.getWithIndex(_loc2_);
