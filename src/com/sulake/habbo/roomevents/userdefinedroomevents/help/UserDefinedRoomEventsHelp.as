package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1042:IContainerButtonWindow;
      
      private var var_1041:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1577 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1041 = this.var_1577.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1041)
         {
            this.var_1041.procedure = this.onButtonClick;
         }
         this.var_1042 = this.var_1577.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1042)
         {
            this.var_1042.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_231 >= this.var_75.length - 1)
         {
            this.var_1042.disable();
         }
         else
         {
            this.var_1042.enable();
         }
         if(this.var_231 <= 0)
         {
            this.var_1041.disable();
         }
         else
         {
            this.var_1041.enable();
         }
      }
      ...
      {
         ++this.var_231;
         this.var_231 = Math.min(this.var_231,this.var_75.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_75[this.var_231][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_75[this.var_231][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_75[this.var_231][1]).value;
