package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1776:TriggerConfs;
      
      private var var_1775:ActionTypes;
      
      private var var_1777:ConditionTypes;
      ...
      {
         this.var_1776 = new TriggerConfs();
         this.var_1775 = new ActionTypes();
         this.var_1777 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1128 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_79.assets,0,20,1);
         this.var_1128.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1128.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_730.hideAll(this.var_247);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_730.showAll(this.var_247);
         if(this.var_35 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_35);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1128.setValue(_loc6_);
         }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_79.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_35.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_35 as TriggerDefinition != null)
         {
            this.var_79.send(new UpdateTriggerMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ActionDefinition != null)
         {
            this.var_79.send(new UpdateActionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ConditionDefinition != null)
         {
            this.var_79.send(new UpdateConditionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1128.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1405) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1405 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_79.send(new ApplySnapshotMessageComposer(this.var_35.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1776);
         this.refreshConfigureElement(this.var_1775);
         this.refreshConfigureElement(this.var_1777);
