package com.sulake.habbo.advertisement.events
{
   ...
   public class AdEvent extends Event
   {
      ...
      public static const const_548:String = "AE_ROOM_AD_SHOW";
      
      public static const const_558:String = "AE_INTERSTITIAL_SHOW";
      
      public static const const_425:String = "AE_INTERSTITIAL_COMPLETE";
      ...
      public function AdEvent(param1:String, param2:int = 0, param3:int = 0, param4:BitmapData = null, param5:String = "", param6:BitmapData = null, param7:BitmapData = null, param8:Boolean = false, param9:Boolean = false)
      {
         ...
         this.var_2594 = param6;
         this.var_2593 = param7;
      }
