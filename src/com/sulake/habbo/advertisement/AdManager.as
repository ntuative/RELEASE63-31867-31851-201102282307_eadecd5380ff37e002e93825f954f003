package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1163:BitmapData = null;
      ...
      {
         this.var_311 = param2 as IHabboCommunicationManager;
         if(this.var_311 == null)
         {
            return;
         }
         this._connection = this.var_311.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2605 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2603 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1844 > 0 && this.var_1845 >= this.var_1844)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1162;
         if(_loc1_ > this.var_2605)
         {
            ++this.var_1845;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1437 != "")
         {
            ...
            {
               this.var_220 = new Timer(this.var_2603,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_558,0,0,param1.bitmapData,this.var_2604));
            this.var_1162 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_425));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1436 = _loc2_.imageUrl;
         this.var_1843 = _loc2_.clickUrl;
         if(this.var_1436 != "" && this.var_1843 != "")
         {
            _loc3_ = this.var_1436;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1436);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_548,0,0,_loc4_,this.var_1843,this.var_1161,this.var_1163));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1163 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
