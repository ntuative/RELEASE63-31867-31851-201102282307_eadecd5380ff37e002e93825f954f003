package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2194:PseudoRandom;
      ...
      private var var_207:HabboHotelView;
      
      private var var_1298:String = "";
      
      private const const_1676:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_563 = param1;
            this.var_51.initConnection(HabboConnectionType.const_241);
         }
      }
      ...
      {
         if(this.var_51 && this.var_143 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_207 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_207.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_143.getKey("use.sso.ticket") == "1";
         this.var_563 = this.var_143.getKey("sso.ticket",null);
         this.var_1602 = this.var_143.getKey("flash.client.url","");
         this.var_2195 = this.var_143.getKey("external.variables.txt","");
         if(this.var_207 == null)
         {
            this.var_207 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_51.mode = HabboConnectionType.const_89;
            if(this.var_563)
            {
               this.var_51.initConnection(HabboConnectionType.const_241);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_470,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_51.mode = HabboConnectionType.const_981;
            }
         }
         this.var_51.initConnection(HabboConnectionType.const_241);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_632);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2194 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_51.mode)
         {
            case HabboConnectionType.const_89:
               ...
               this.var_207.loadBannerImage(_loc7_ + "?token=" + this.var_1298,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_981:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1501:
               this.var_858 = this.generateRandomHexString(30);
               this.var_477 = new DiffieHellman(new BigInteger(this.var_143.getKey("connection.development.prime"),16),new BigInteger(this.var_143.getKey("connection.development.generator"),16));
               this.var_477.init(this.var_858);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2194);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1602,this.var_2195));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1676,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_563 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_563);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2193)
         {
