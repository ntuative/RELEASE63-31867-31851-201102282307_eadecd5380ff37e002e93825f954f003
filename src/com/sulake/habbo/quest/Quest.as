package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2581:uint = 2;
      
      private var var_2582:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1758 = param1.roomItemTypeName;
         this.var_1757 = param1.rewardCurrencyAmount;
         this.var_1831 = new Date();
         this.var_1831.setTime(param1.endDateTimeStamp);
         this.var_727 = param1.localizationCode;
      ...
      private function createView() : void
      {
         switch(this.var_378)
         {
            case QuestStatusEnum.const_46:
               ...
               break;
            case QuestStatusEnum.const_576:
            ...
            case QuestStatusEnum.const_174:
               ...
               break;
            case QuestStatusEnum.const_691:
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_62.code,this.var_727].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_199)
            {
               this.var_940.style = this.var_2582;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_199)
            {
               this.var_940.style = this.var_2581;
            }
         }
      }
