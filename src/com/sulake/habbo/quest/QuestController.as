package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_302:QuestCampaign;
      
      private var var_659:Boolean = false;
      
      private var _window:IFrameWindow;
      
      private var var_1143:IWindowContainer;
      ...
      {
         var _loc3_:QuestCampaign = this.var_152[param1];
         if(!_loc3_)
         {
            _loc3_ = new QuestCampaign(this,param1);
            this.var_152[param1] = _loc3_;
         }
         if(_loc3_)
         {
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_189.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      {
         if(this.var_643 != MODE_TABS)
         {
            this.var_643 = MODE_NO_TABS;
         }
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_152[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_152[param1] = _loc4_;
         }
         _loc4_.activityPointType = param2;
         this.var_302 = _loc4_;
         this.var_302.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_643 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1143.addChild(this.var_302.window);
         var _loc1_:String = "quest_" + this.var_302.code;
      ...
      public function openCampaigns(param1:Array, param2:Boolean = false) : void
      {
         ...
         this.var_643 = MODE_TABS;
         for each(_loc3_ in param1)
         {
            _loc4_ = this.var_152[_loc3_];
            if(!_loc4_)
            {
               _loc4_ = new QuestCampaign(this,_loc3_);
               this.var_152[_loc3_] = _loc4_;
            }
      ...
      private function updateTabs() : void
      {
         ...
         if(this.var_302)
         {
            _loc1_ = this.var_302.code;
         }
         else if(this.var_152.getKeys().length > 0)
         {
            _loc1_ = this.var_152.getKeys()[0];
         }
         if(_loc1_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_189.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1143 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_152.getKeys())
         {
            _loc3_ = this.var_152[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc2_ = this.var_189.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_441) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_189.getQuestCampaign(param2.caption);
      }
   }
}
