package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_500:Quest;
      
      private var var_293:QuestView;
      ...
      private var var_292:IItemListWindow;
      ...
      private function reset() : void
      {
         ...
         if(this.var_357)
         {
            ...
            {
               this.var_292.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_357 = null;
            this.var_292.destroyListItems();
            this.var_292.removeListItems();
         }
         this.var_500 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1396 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_292 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1396.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1396.findChildByName("currency.amount").caption = "${quest_" + this.var_1767 + ".currency}";
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_500)
         {
            this.var_500.selected = false;
         }
         if(this.var_179)
         {
            this.var_1126.addChild(this.var_179.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1651);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1396.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_292.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_46 || _loc4_.status == QuestStatusEnum.const_576))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_292.maxScrollV > 0)
            {
               this.var_292.scrollV = _loc3_.view.y / this.var_292.maxScrollV;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_500 = param1;
         this.var_500.selected = true;
         this.showQuestData(this.var_500);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_293 = new QuestView(this,param1);
         this.var_1126.addChild(this.var_293.view);
         this.var_293.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_728.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_728)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_728.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_728.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc6_ = this.var_292.getListItemIndex(_loc2_.view);
            this.var_292.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_292.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_292.addListItem(_loc5_.view);
            }
            if(this.var_500 == _loc2_)
            {
