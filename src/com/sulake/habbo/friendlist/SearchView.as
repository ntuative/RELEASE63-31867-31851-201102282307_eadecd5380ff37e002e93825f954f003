package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_420:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_420 = new AvatarPopupCtrl(this._friendList);
      }
      
      public function getEntryCount() : int
      {
         if(this._friendList.method_2.friends == null)
         {
            return 0;
         }
         return this._friendList.method_2.friends.length + this._friendList.method_2.others.length;
      }
      ...
      {
         this.var_739 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_739.procedure = this.onSearchInput;
         this.var_739.addEventListener(WindowKeyboardEvent.const_178,this.onSearchStrInput);
      ...
      public function refreshList() : void
      {
         ...
         var _loc1_:AvatarSearchResults = this._friendList.method_2;
         var _loc2_:int = 0;
         while(true)
         {
            if(_loc2_ == 0)
            ...
            else if(_loc2_ <= _loc1_.friends.length + _loc1_.others.length + 1)
            {
               ...
               this.refreshEntry(true,_loc2_,_loc4_.avatarFigure,_loc4_.avatarName,null,false,false,_loc4_.avatarId != this._friendList.avatarId && !this._friendList.method_2.isFriendRequestSent(_loc4_.avatarId),_loc4_.avatarId);
            }
            else
            {
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_57.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_374,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         this.var_739.text = param1;
      }
      
      private function getFriendsCaption() : String
      {
         if(this._friendList.method_2.friends.length == 0)
         {
            return "${friendlist.search.nofriendsfound}";
         }
         this._friendList.registerParameter("friendlist.search.friendscaption","cnt","" + this._friendList.method_2.friends.length);
         return "${friendlist.search.friendscaption}";
      }
      
      private function getOthersCaption() : String
      {
         if(this._friendList.method_2.others.length == 0)
         {
            return "${friendlist.search.noothersfound}";
         }
         this._friendList.registerParameter("friendlist.search.otherscaption","cnt","" + this._friendList.method_2.others.length);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this._friendList.method_2.getResult(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
            this.var_420.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_420.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_420.closePopup();
         }
      }
      ...
      private function onAskForFriendButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:HabboSearchResultData = this._friendList.method_2.getResult(param2.id);
         if(_loc3_ == null)
         {
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_739.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_739.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_739.text;
