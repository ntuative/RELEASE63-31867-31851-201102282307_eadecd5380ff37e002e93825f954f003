package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1812:int = "F".charCodeAt(0);
      
      public static const const_1893:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_987 = param1.gender;
         this.var_695 = param1.online;
         this.var_1762 = param1.followingAllowed && param1.online;
         this.var_645 = param1.figure;
         this.var_1920 = param1.motto;
         this.var_1663 = param1.lastAccess;
         this.var_1288 = param1.categoryId;
         this.var_1664 = param1.realName;
