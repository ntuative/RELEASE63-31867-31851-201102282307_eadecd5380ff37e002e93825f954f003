package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1697:String = "noconvinfo";
      
      private static const const_1698:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1410:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1410 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_941 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_230 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1410.prepare(this.var_941);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1169,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1161,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_765,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_889,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_765,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_889,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1409 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1409.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1784 == -1 ? 0 : int(this.var_16.height - this.var_1784);
         var _loc4_:int = this.var_1785 == -1 ? 0 : int(this.var_16.width - this.var_1785);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1073,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_765,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1169,false);
         ...
         this.var_1784 = this.var_16.height;
         this.var_1785 = this.var_16.width;
      ...
      public function get method_11() : FriendListTabsView
      {
