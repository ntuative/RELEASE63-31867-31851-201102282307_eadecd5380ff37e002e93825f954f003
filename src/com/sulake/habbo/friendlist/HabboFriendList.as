package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1044:IAvatarRenderManager;
      
      private var var_674:ISessionDataManager;
      
      private var var_2157:FriendListLookAndFeel;
      ...
      private var var_329:FriendRequests;
      
      private var var_1581:AvatarSearchResults;
      ...
      {
         this.var_2157 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1581 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_557.stop();
            this.var_557.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_557 = null;
         }
         ...
         if(this.var_1044)
         {
            this.var_1044.release(new IIDAvatarRenderManager());
            this.var_1044 = null;
         }
         if(this.var_901)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1582 = new OpenedToWebPopup(this);
         }
         this.var_1582.show(x,y);
      }
      ...
      public function canBeAskedForAFriend(param1:int) : Boolean
      {
         ...
         return this.getFriend(param1) == null && !this.method_2.isFriendRequestSent(param1) && this.categories.getFriendCount(false) < this.friendRequests.limit;
      }
      ...
      public function askForAFriend(param1:int, param2:String) : Boolean
      {
         ...
         this.method_2.setFriendRequestSent(param1);
         return true;
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_329.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_297,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1044.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1044 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_901 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_329 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_95.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1116,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_361,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_557)
         {
            this.var_557 = new Timer(120000);
            this.var_557.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_557.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_361);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_329.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_329.addRequest(new FriendRequest(_loc3_));
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_329.addRequestAndUpdateView(_loc3_);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1581.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function get method_2() : AvatarSearchResults
      {
      ...
      {
         if(!this.var_674 || !this.var_329)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_674.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_329.vipLimit;
         }
         else if(this.var_674.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
            _loc2_ = this.var_329.clubLimit;
         }
         if(_loc2_ > this.var_329.limit)
         {
            this.var_329.limit = _loc2_;
         }
      }
