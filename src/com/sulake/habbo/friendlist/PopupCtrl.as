package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_54 == null)
         {
            this.var_54 = IWindowContainer(this._friendList.getXmlWindow(this.var_990));
         ...
         this.var_54.x = _loc4_.x - _loc3_.x + this.var_2207 + param2.width;
