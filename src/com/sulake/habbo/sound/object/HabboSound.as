package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1058:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1058.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_488 = 1;
         this.var_1307 = false;
      }
      ...
      {
         this.var_1307 = false;
         this._soundChannel = this.var_1058.play(0);
      ...
      {
         return this.var_1058.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1058.isBuffering;
      }
