package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_2695:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_659)
         {
            ...
            if(this.var_782)
            {
               for each(_loc2_ in this.var_782)
               {
                  _loc2_.dispose();
               }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_263.length == 1 && this.var_88 == this.var_1997)
         {
            return this.var_88 + this.var_521 + this.var_637 % 4;
         }
         if(this.var_263.length == 2)
         {
            for each(_loc1_ in this.var_263)
            {
               ...
               {
                  return this.var_88 + this.var_521 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_637 % 11;
                  return this.var_88 + "_" + this.var_1997 + this.var_521 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2693 || param2 != this.var_2694 || param1 != this.var_2695)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1240 || this.var_44 == null || (this.var_44.width != _loc5_.width || this.var_44.height != _loc5_.height))
         {
            if(this.var_44 != null && !this.var_1240)
            {
               this.var_44.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_637);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_637);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_315.push(new ActiveActionData(param1,param2,this.var_637));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_860);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_521 = "";
         this.var_263 = this._structure.sortActions(this.var_315);
         if(this.var_263 == null)
         {
         ...
         {
            this.var_729 = this._structure.getCanvasOffsets(this.var_263,this._scale,this.var_88);
            for each(_loc4_ in this.var_263)
            {
               this.var_521 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_288)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1468 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_263)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_859 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_324 || _loc1_.actionType == AvatarAction.const_218 || _loc1_.actionType == AvatarAction.const_354)
               {
                  this.var_859 = true;
               }
            }
