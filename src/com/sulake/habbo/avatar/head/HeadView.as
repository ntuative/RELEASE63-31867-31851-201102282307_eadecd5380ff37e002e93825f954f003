   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_194,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_243,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_263,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_249,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_246,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_66 && var_137 == "")
         {
            var_66.switchCategory(FigureData.const_194);
         }
      }
