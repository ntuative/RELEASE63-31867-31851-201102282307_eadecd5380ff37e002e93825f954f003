package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1911 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2698 = parseInt(_loc2_,16);
         this.var_2697 = parseInt(_loc3_,16);
         ...
         this.var_1633 = new ColorTransform(this.var_1827,this.var_1829,this.var_1828,this._alphaMultiplier);
         this.var_1203 = this.generatePaletteMapForGrayscale(this.var_2697,this.var_2698);
      }
