package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1941:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1124 = [];
         this.var_1392 = [AvatarEditorFigureCategory.const_656,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_244,AvatarEditorFigureCategory.const_673,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_101];
         super();
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1756 == AvatarEditorSideCategory.const_101 || this.var_2482))
         {
         ...
         this.setViewToCategory(this.var_328);
      }
      ...
      {
         if(this.var_1756 == AvatarEditorSideCategory.const_101)
         {
            this.var_2482 = false;
            this.setSideContent(AvatarEditorSideCategory.const_807);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_807:
               break;
            case AvatarEditorSideCategory.const_567:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_567);
               break;
