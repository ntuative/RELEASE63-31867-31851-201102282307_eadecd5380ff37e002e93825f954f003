package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2503 = parseInt(param1.@precedence);
         this.var_2504 = String(param1.@activepartset);
         this.var_2501 = String(param1.@assetpartdefinition);
         this.var_2502 = String(param1.@lay);
         this.var_660 = String(param1.@geometrytype);
         this.var_2012 = Boolean(parseInt(param1.@main));
         this.var_2505 = Boolean(parseInt(param1.@method_4));
         this.var_2506 = Boolean(parseInt(param1.@animation));
