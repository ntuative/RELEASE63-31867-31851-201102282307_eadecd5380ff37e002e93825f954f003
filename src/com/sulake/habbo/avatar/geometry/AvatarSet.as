package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2012 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         ...
         {
            this.var_1504.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1504.concat();
