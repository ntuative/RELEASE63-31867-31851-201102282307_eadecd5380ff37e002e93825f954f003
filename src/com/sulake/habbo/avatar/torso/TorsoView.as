   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_217,_windowManager,_assetLibrary);
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_239,_windowManager,_assetLibrary);
         }
         else
         {
