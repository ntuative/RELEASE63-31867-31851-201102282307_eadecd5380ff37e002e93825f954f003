package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1258:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1259:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1078:AvatarEditorHandler;
      ...
      private var var_871:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_183)
         {
            ...
            this.var_572["null"] = new FigureData(this);
            this.var_572["null"] = new FigureData(this);
            _loc2_ = this.var_572["null"];
            _loc3_ = this.var_572["null"];
            _loc2_.loadAvatarData(const_1258,FigureData.const_73);
            _loc3_.loadAvatarData(const_1259,FigureData.FEMALE);
            this.var_95 = new Map();
            this.var_481 = new Map();
            this.var_95.add(AvatarEditorFigureCategory.const_656,new BodyModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_244,new TorsoModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_673,new LegsModel(this));
            ...
            this.var_481.add(AvatarEditorSideCategory.const_101,new WardrobeModel(this));
            this.var_481.add(AvatarEditorSideCategory.const_567,new ClubPromoModel(this));
            this.var_183 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_572[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_871.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_871.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_656);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_481.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_480 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_871 = this.var_480.getFigureData(AvatarType.const_118);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1078 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_572[this.var_987];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1324 != null)
         {
            ...
            this.var_1324.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_480.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_480.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1387)
               {
                  _loc23_ = true;
               }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_481.getValue(AvatarEditorSideCategory.const_101);
      }
