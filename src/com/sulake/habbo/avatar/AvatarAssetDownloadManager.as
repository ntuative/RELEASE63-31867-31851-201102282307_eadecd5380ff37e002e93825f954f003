package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_1560:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_954 = new Timer(this.const_1997,1);
         this.var_954.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_426)
         {
            this.var_426.addEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_426.addEventListener(AssetLoaderEvent.const_45,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_426)
         {
            this.var_426.removeEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_426.removeEventListener(AssetLoaderEvent.const_45,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_955);
            if(this.var_1434.indexOf("?") > 0)
            {
               _loc2_ = this.var_1434 + "&retry=" + this.var_955;
            }
            else
            {
               _loc2_ = this.var_1434 + "?retry=" + this.var_955;
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2598,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1840)
         {
            this.var_1159.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_953)
         {
            _loc7_ = true;
            _loc4_ = this.var_953[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_759.length > 0 && this.var_758.length < this.const_1560)
         {
            _loc1_ = this.var_759[0];
            _loc1_.startDownloading();
            this.var_758.push(this.var_759.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_759.indexOf(param1) == -1 && this.var_758.indexOf(param1) == -1)
         {
