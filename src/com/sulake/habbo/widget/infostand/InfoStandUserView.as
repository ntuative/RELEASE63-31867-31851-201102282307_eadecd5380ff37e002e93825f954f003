package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private const const_960:int = 5;
      
      private const const_1702:int = 39;
      
      private const const_1703:int = 7829367;
      
      private const const_1701:int = 16777215;
      
      private const const_1992:int = 2000;
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_187.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_187.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_187.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_187.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_960;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_960;
         if(param2)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1089:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1011:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2563 > this.const_1992 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
         ...
         else
         {
            ...
            if(_loc3_.length >= this.const_1702)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1702 - 1);
            }
         }
      }
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            if(param2.name == "button.give")
            {
               ...
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_620);
               }
               if(_loc3_ <= -1)
               {
                  return;
