package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1678:String = "infostand_user_view";
      ...
      private var var_1082:InfoStandFurniView;
      ...
      private var var_1327:InfostandUserData;
      
      private var var_595:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1082 = new InfoStandFurniView(this,this.const_1679,this._catalog);
         this.var_125 = new InfoStandUserView(this,this.const_1678);
         this.var_339 = new InfoStandPetView(this,this.const_1680,this._catalog);
         this.var_402 = new InfoStandBotView(this,this.const_1681);
         this.var_1327 = new InfostandUserData();
         this.var_595 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_144 = new Timer(this.const_1974);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_60,HabboWindowStyle.const_42,HabboWindowParam.const_42,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_125,this.onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_306,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_688,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_622,this.onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_104,this.onPetInfo);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_125,this.onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_306,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_688,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_622,this.onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_104,this.onPetInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_406,this.var_339.getCurrentPetId()));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_125.setTags(param1.tags,this.var_2319);
         }
      }
