package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_39 = param3;
         this.var_2204 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1605 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2200 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1604 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1603 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2202 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2203 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         ...
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_60,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_39.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_39.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_899,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_448:
               this.var_73.blend += param1 / const_920;
               ...
               break;
            case const_965:
               this.var_73.blend -= param1 / const_921;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_39.width - this.var_2199;
         }
         if(this.var_73 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2201 == this._window.width)
         {
            return;
         }
         this.var_2201 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2200;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1604;
            _loc2_.disposesBitmap = false;
            this.var_2199 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2204,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1605,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1605,_loc9_);
         ...
         this.var_73.bitmap = this.var_2203;
