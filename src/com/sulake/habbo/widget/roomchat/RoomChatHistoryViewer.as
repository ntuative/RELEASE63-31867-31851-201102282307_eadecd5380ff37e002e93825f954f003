package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1342:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_178.state = RoomChatHistoryPulldown.const_266;
         ...
         this.var_47 = param2.createWindow("chatscroller","",HabboWindowType.const_1105,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_178.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_266);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_178.state == RoomChatHistoryPulldown.const_384 || this.var_178.state == RoomChatHistoryPulldown.const_448;
      }
      ...
      {
         if(!this.var_422 && !this.var_1660)
         {
            this.var_422 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_178.state = RoomChatHistoryPulldown.const_384;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_47 != null)
         {
            ...
            if(param2)
            {
               this.var_47.scrollV = this.var_621;
            }
         }
         if(this.var_178 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_421 > 0 && param2)
         {
            if(this.var_1824)
            {
               if(Math.abs(param1 - this.var_421) <= const_1148)
               {
                  return;
               }
               this.var_1824 = false;
            ...
            if(this.var_422)
            {
               ...
               _loc5_ = (param1 - this.var_421) / this.var_47.height;
               _loc3_ = this.var_621 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_421;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_47.scrollV < 1 - const_1342 / this.var_47.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1825)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_47 != null)
         {
            this.var_621 = this.var_47.scrollV;
         }
         if(this.var_47 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_621 - this.var_47.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
