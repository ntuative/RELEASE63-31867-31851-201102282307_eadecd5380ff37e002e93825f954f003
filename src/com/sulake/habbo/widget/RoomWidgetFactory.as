package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2761:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2761 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_350:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_75,this.var_143,this.var_2019++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_75,this);
               break;
            case RoomWidgetEnum.const_580:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_75,this.var_143,this._catalog);
               break;
            case RoomWidgetEnum.const_457:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_75,events,this.var_143);
               break;
            ...
            case RoomWidgetEnum.const_555:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_75,this.var_143,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_456:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_75,this.var_143);
               break;
            case RoomWidgetEnum.const_722:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_75,this.var_143);
               break;
            case RoomWidgetEnum.const_112:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_75,this.var_143);
               break;
