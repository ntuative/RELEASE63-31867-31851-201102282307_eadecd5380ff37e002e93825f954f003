package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_1991:int = 1000;
      ...
      private var var_732:ITextWindow;
      ...
      {
         super();
         this.var_194 = new Timer(this.const_1991);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_174.isActive)
         {
            ...
            this.var_929.width = _loc2_ * this.var_295;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_732 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_732 == null)
            {
               return;
            }
         ...
         if(!this.var_174.isActive)
         {
            this.var_732.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_732.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_732.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_929 != null)
         {
            this.var_295 = this.var_929.width;
            this.var_194.start();
            this.onUpdate();
         }
