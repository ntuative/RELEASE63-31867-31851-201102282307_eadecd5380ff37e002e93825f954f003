package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1714:uint = 0;
      
      private const const_2000:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_1714) : uint(this.const_1715);
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(this.var_973 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_973 % 2) ? uint(this.const_1714) : uint(this.const_1715);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2000;
            this.var_973 = param1;
         }
      }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1896);
      }
