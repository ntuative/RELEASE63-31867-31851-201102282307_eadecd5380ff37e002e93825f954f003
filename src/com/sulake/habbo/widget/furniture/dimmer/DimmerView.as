package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_633:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_60,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1221,const_1220,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_633 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1452 = _loc2_.light;
         if(this.var_431 != null)
         {
            this.var_431.setValue(this.var_1452);
         }
         this.var_476 = this.colors.indexOf(_loc2_.color);
         if(this.var_633 != null)
         {
            this.var_633.setSelectedColorIndex(this.var_476);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1453 = XML(_loc1_.content);
         return this.var_1453;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_633 != null)
         {
            this.var_633.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
