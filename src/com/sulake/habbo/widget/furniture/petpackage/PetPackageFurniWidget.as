package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_341,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_341,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_550:
               this.hideInterface();
               this.var_319 = event.objectId;
               this.var_554 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_429:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_341:
               if(event.objectId != this.var_319)
               {
                  return;
               }
               this.var_554 = event.image;
      ...
      private function showInterface() : void
      {
         ...
         this._window.x = const_1221;
         this._window.y = const_1220;
      ...
      {
         var _loc2_:* = null;
         if(this.var_554 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_554.width) / 2,(_loc1_.height - this.var_554.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_554,this.var_554.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1037 || this.var_319 == -1)
         {
            return;
         }
         ...
         {
            this.var_1037 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_813,this.var_319,name);
