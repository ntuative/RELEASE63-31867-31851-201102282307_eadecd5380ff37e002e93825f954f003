package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1696:int = 3;
      
      private const const_1695:int = 4;
      
      private const const_1983:int = 0;
      
      private const const_1985:int = 1;
      
      private const const_1988:int = 2;
      
      private const const_1990:int = 3;
      
      private const const_1989:int = 4;
      
      private const const_1987:int = 5;
      
      private const const_1694:String = "deco_img";
      
      private const const_1693:String = "dialog_bg";
      
      private const const_1982:String = "%campaign%_dialog_bg.png";
      
      private const const_332:String = "%campaign%_gift_package.png";
      
      private const const_1986:String = "%campaign%_gift_content.png";
      
      private const const_1984:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1400 = this.var_143.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1400 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1397.length)
         {
            _loc2_ = this.var_1397.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_143 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_505,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_806,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_821,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_505,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_505:
               _loc2_ = this.const_1690;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_821:
               ...
               this._shareId = null;
               this.var_1398 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_806:
               _loc2_ = this.const_1692;
               this.var_319 = param1.objectId;
         ...
         if(this._window && (this.var_1399 != _loc2_ || _loc3_ != this.var_173))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1399)
            {
               ...
               case this.const_1692:
                  if(this.var_378 == this.const_1983)
                  {
                  ...
                  else if(this.var_378 == this.const_1990)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_378 == this.const_1989)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_173,"client.show.not_enough_fb_friends");
            ...
            _loc5_ = this.const_1982.replace("%campaign%",this.var_173);
            this.setDecoImage(_loc5_,this.const_1693);
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_752);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1398 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1398 == 1 ? "null" : InventoryCategory.const_141);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_790,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1397.push(new ImageDownloader(this,_assets,this.var_173,this.var_1400,param1,param2));
            return;
         }
