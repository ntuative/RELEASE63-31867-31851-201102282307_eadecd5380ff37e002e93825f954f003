package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1227:String = "room_view";
      
      private const const_1956:String = "room_widget";
      
      private var var_56:IWindowContainer;
      
      private var var_662:int = 50;
      
      private var var_2762:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < this.var_56.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_287,this.trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_1956) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_56.getChildByTag(this.const_1227) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_662;
               _loc2_.width = this.var_56.desktop.width - this.var_662;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_662;
               _loc2_.height = this.var_56.desktop.height - this.var_662;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_56.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_56.findChildByTag(this.const_1227) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
