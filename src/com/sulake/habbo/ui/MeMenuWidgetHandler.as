   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_737,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_767,this.onHabboClubSubscriptionChanged);
            }
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_737,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_767,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1344)
            {
               ...
               this.var_1344 = _loc2_;
               this.var_1688 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1688;
            }
         }
         if(this.var_171 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1178,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_775);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_782);
         ...
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1555);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1039);
         _loc1_.push(RoomWidgetToolbarMessage.const_876);
         _loc1_.push(RoomWidgetToolbarMessage.const_838);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_336);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1389);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1206);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_649);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_619);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_827);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_619:
            ...
            case RoomWidgetWaveMessage.const_683:
               ...
               break;
            case RoomWidgetDanceMessage.const_775:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_782:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetNavigateToRoomMessage.const_1039:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_649:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_876:
               ...
               if(this.var_171)
               {
                  this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_838:
               ...
               {
                  this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_480,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_336:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_481));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_827:
            ...
            case RoomWidgetClothingChangeMessage.const_379:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_904));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_730));
      }
