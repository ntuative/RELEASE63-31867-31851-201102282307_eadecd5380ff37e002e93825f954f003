package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_766,RoomWidgetEcotronBoxOpenMessage.const_631,RoomWidgetEcotronBoxOpenedMessage.const_1619];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_766:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_631:
