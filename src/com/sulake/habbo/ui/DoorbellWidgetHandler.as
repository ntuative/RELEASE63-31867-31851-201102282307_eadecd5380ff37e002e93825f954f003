package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_695];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_695:
      ...
      {
         return [RoomSessionDoorbellEvent.const_114,RoomSessionDoorbellEvent.const_144,RoomSessionDoorbellEvent.const_46];
      }
