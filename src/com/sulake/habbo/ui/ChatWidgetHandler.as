package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1151:Number = 0.0;
      
      private var var_751:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_304 != null)
         {
            ...
            {
               _loc2_ = this.var_304.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_840,RoomWidgetChatSelectAvatarMessage.const_895];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_840:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1174))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1174))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_895:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_304.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_423.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_622.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_622.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_180)
                                    {
                                       this.var_304.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1151 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1151);
            }
            if(this.var_751 == null)
            {
               ...
               this.var_509.y = 0;
               this.var_509.z = 0;
               this.var_751 = _loc4_.getScreenPoint(this.var_509);
               this.var_1151 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_509.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_751.x || _loc8_.y != this.var_751.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_751,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_304)
         {
            _loc2_ = this.var_304.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1150.push(_loc2_);
            }
         }
      }
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_622.add(param1,_loc7_);
                  }
               }
            }
         }
