package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_104,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_104,this.onPetInfo);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_340);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_322);
         _loc1_.push(RoomWidgetFurniActionMessage.const_723);
         _loc1_.push(RoomWidgetFurniActionMessage.const_862);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_825);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1402);
         _loc1_.push(RoomWidgetPetCommandMessage.const_442);
         _loc1_.push(RoomWidgetPetCommandMessage.const_896);
         _loc1_.push(RoomWidgetUserActionMessage.const_486);
         _loc1_.push(RoomWidgetUserActionMessage.const_406);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_671);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_406 || param1.type == RoomWidgetUserActionMessage.const_486 || param1.type == RoomWidgetUserActionMessage.const_477)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_340:
            ...
            case RoomWidgetUserActionMessage.const_802:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1211,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_406:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_825:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_306);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_365);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_193)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_877)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_138)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_893);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1089;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1011;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1573);
               }
               else
               {
