package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2005:int = 2500;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1478));
         this.var_1477.add(this.var_1478,getTimer());
         ++this.var_1478;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1477.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2005)
            {
