package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_916:int = 32;
      
      private static const const_1233:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2138,this.var_425,this.var_171,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_770 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_916;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_206.length)
         {
            _loc3_ = this.var_206[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_770 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_770 + const_1233;
            _loc2_++;
         }
         return _loc1_;
      }
