package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_171 != null && this.var_1077)
         {
            this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1077 = false;
         }
         this._controller.inventoryViewOpened(this.var_687);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(this.var_171 != null && this.var_1077)
            {
               this.var_171.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1077 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_687);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_171.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1643);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_688 == InventoryCategory.const_141)
            {
               this.toggleCategoryView(InventoryCategory.const_141);
            }
            else if(this.var_688 == InventoryCategory.const_78)
            {
