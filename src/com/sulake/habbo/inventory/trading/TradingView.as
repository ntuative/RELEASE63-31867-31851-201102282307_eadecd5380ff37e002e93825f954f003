package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_955:uint = 4284532064;
      
      private static const const_954:uint = 2577770;
      ...
      private var var_420:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_420 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1801 = this.createMinimizedWindow();
         }
         if(!this.var_2536)
         {
            return this.var_68;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_68)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_955) : uint(const_954);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_955) : uint(const_954);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1186)
            {
            ...
            this.var_420.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_434);
            this.var_420.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_420.hideDelayed();
         }
      }
