package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1462:uint = 9;
      
      public static const const_200:uint = 0;
      
      public static const const_176:uint = 1;
      
      public static const const_347:uint = 2;
      
      public static const const_290:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_55.updateItemList(this.var_715);
         this.var_55.updateItemList(this.var_1367);
      ...
      public function close() : void
      {
         if(this.var_665)
         {
            if(this._state != const_200 && this._state != const_230)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_716 + " OTHER: " + this.var_1109);
         ...
         {
            case const_200:
               if(param1 == const_176 || param1 == const_230)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_239.length)
         {
            _loc2_ = this.var_239.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         if(this._state == const_347)
         {
            this.state = const_290;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1035);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_715)
            {
               this.var_716 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1109 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_55.updateUserInterface();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_239.length < const_1462)
         {
