package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1187 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1187.procedure = this.inactiveGridEventProc;
         this.var_1188 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1188.procedure = this.activeGridEventProc;
      }
