package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1318:int = 100;
      ...
      private var var_1724:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_594 = new Timer(const_1318,1);
         this.var_594.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2429 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_594.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_594.stop();
               this.var_594 = null;
            }
            if(this.var_190 != null)
            {
               this.var_190.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_190.stop();
               this.var_190 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1724 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1724;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_909 == null)
         {
            this.var_909 = this._windowManager.buildFromXML(this.var_2429) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_909.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_190 = new Timer(param1,1);
            this.var_190.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_190.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_387);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_595.add(const_44,new Array());
         this.var_595.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_274;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_351 || _loc3_.category == FurniCategory.const_344 || _loc3_.category == FurniCategory.const_392)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1369 && param1.type == RoomEngineObjectEvent.const_240)
         {
            this.var_1369 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_595.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_630)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
