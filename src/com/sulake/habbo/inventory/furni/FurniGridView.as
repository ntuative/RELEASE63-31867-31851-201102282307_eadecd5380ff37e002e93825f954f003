   ...
   public class FurniGridView
   {
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_234.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_66.toggleItemSelection(this._category,this.var_234.getGridItemIndex(param1.window));
            this.var_570 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_570 != null && this.var_570 == param2 && !this.var_66.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_321)
         {
