package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2006:int = 0;
      
      private const const_946:int = 1;
      
      private const const_1669:int = 2;
      
      private const const_1672:int = 3;
      
      private const const_1671:int = 42;
      
      private const const_1670:int = 120;
      ...
      private var var_761:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_381.add(FurniModel.const_44,new FurniGridView(this.var_66,FurniModel.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_381.add(FurniModel.const_48,new FurniGridView(this.var_66,FurniModel.const_48,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_381.getValue(this.var_382);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_382);
         if(!this.var_66.isListInited())
         {
            _loc2_ = this.const_946;
         }
         ...
         {
            _loc2_ = this.const_1672;
         }
         if(this.var_2018 == _loc2_)
         {
            return;
         }
         this.var_2018 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_381.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_381.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_381.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_382);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_761 && this.var_761.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1670)
         {
            _loc3_ = this.const_1670;
         }
         else if(_loc3_ < this.const_1671)
         {
            _loc3_ = this.const_1671;
         }
         else
         {
