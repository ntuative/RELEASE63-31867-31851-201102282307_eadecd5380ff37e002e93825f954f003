package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2321:int;
      
      protected var var_1491:Boolean;
      
      protected var var_1995:Boolean;
      
      protected var var_2755:BitmapData;
      
      private const const_1957:int = 8947848;
      
      private const const_1958:int = 13421772;
      
      private const const_1709:Number = 1;
      
      private const const_1708:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1418));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1986);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_630)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1708;
               _loc1_.blend = this.const_1708;
            }
            else
            {
               this._window.blend = this.const_1709;
               _loc1_.blend = this.const_1709;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1995 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2755;
               _loc5_.visible = true;
            }
            else
            {
