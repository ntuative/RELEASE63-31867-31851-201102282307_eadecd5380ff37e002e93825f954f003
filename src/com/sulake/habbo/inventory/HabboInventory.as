package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1953:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_502,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_274));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_801));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_307));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_372));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_49.getValue(InventoryCategory.const_141));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_49.getValue(InventoryCategory.const_387) as MarketplaceModel;
      }
      ...
      {
         this.var_401 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_502,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_401 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_171)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_171);
         this.var_49 = new Map();
         ...
         this.var_49.add(InventoryCategory.const_387,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_401);
         this.var_49.add(InventoryCategory.const_307,_loc3_);
         ...
         this.var_49.add(InventoryCategory.const_801,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_401);
         this.var_49.add(InventoryCategory.const_372,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_274,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_141,_loc8_);
         this.var_183 = true;
         if(this.var_2004)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_810.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_810.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_810.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_810.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1953);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_737));
      }
