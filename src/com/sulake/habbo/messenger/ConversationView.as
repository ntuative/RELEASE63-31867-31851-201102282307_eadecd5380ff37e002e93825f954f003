package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_958:int = 100;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         ...
         this.var_2548 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_958 + const_1330)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1331;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_507 == null || _loc1_.id != this.var_507.id)
         {
            this.var_507 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_507.followingAllowed)
         {
      ...
      private function refreshList() : void
      {
         ...
         this.var_57.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_507.messages.length - const_958);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_507.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_507.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_738 || param3.type == Message.const_880 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_507.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_128.send(new FollowFriendMessageComposer(this.var_507.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1141)
         {
            return 4294927974;
         }
         if(param1 == Message.const_843)
         {
            return 4293454056;
         }
         if(param1 == Message.const_858)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1065)
         {
            return 4288269465;
         }
         return 4291611852;
