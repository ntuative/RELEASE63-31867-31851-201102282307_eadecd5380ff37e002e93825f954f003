package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_905:Number = 0.71;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1147,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_23);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1147,error);
            Core.dispose();
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_275,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_275,null);
         }
         if(this.var_23)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_275,null);
         }
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_905 + this.var_23.getNumberOfFilesLoaded() / _loc11_ * const_905;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
